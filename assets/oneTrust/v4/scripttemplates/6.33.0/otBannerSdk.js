...
! function() {
    ...
    var ke = "AwaitingReconsent",
        ...
        mt = (Pt.prototype.setRegionRule = function(e) {
            ...
            var t = e.DomainData;
            this.setPublicDomainData(JSON.parse(JSON.stringify(t))), this.domainDataMapper(t), this.commonDataMapper(e.CommonData), St.NtfyConfig = e.NtfyConfig || {}, this.setBannerName(), this.setPcName(), this.populateGPCSignal(), St.GoogleConsent.GCEnable && this.initGCM()
            ...
            if (e && !e.Parent) {
                ...
                (-1 < yt.indexOf(e.Type) || i) && (e.ShowVendorList = !0), (e.Hosts.length || r || n) && (e.ShowHostList = !0)
            }
            ...
            e.forEach(function(e) {
                ...
                if (void 0 !== e.HasConsentOptOut && e.IsIabPurpose || (e.HasConsentOptOut = !0), !(!r.IsIabEnabled && -1 < yt.indexOf(e.Type) || "IAB2" === s.iabType && (e.Type === pt || e.Type === Ct) && !e.HasConsentOptOut && !e.HasLegIntOptOut || e.Type === ht && !e.HasConsentOptOut) && (t !== At.purposeOneGrpId || e.ShowInPopup || (s.purposeOneTreatment = !0), s.grpContainLegalOptOut = e.HasLegIntOptOut || s.grpContainLegalOptOut, e.SubGroups = [], e.Parent ? a.push(e) : i[t] = e, "IAB2" === s.iabType && -1 < yt.indexOf(e.Type))) {
            ...
            e.forEach(function(e) {
                C([e], e.SubGroups).forEach(function(e) {
                    var t;
                    e.Type !== dt && e.Type !== pt && e.Type !== ht || (o.domainGrps[e.PurposeId.toLowerCase()] = e.CustomGroupId), -1 < ft.indexOf(e.Type) && o.consentableGrps.push(e), -1 < kt.indexOf(e.Type) && o.consentableIabGrps.push(e), -1 === ft.indexOf(e.Type) && o.iabGrps.push(e), o.gpcEnabled && e.IsGpcEnabled && (e.Status = Ge), (t = o.DNTEnabled && e.IsDntEnabled ? Oe : e.Status.toLowerCase()) !== xe && t !== Ve && t !== Oe || (n = !1), t !== Ve && t !== we && (r = !1), o.gpcForAGrpEnabled || (o.gpcForAGrpEnabled = e.IsGpcEnabled)
                })
            ...
            e.PCTemplateUpgrade && (e.Center || e.Panel) && e.PCAccordionStyle === W.PlusMinus && (t.PCAccordionStyle = e.PCAccordionStyle), t.PCenterEnableAccordion = e.PCAccordionStyle !== W.NoAccordion, this.legIntSettings = e.LegIntSettings || {}, void 0 === this.legIntSettings.PAllowLI && (this.legIntSettings.PAllowLI = !0), lt.moduleInitializer.MobileSDK || (this.pagePushedDown = e.BannerPushesDownPage), St = r(r({}, St), t)
            ...
            this.gpcValueChanged = e ? e != t : this.gpcForAGrpEnabled, this.gpcForAGrpEnabled && Lt.writeCookieParam(Te.OPTANON_CONSENT, Se, t)
    ...
    var Lt, _t = new(It.prototype.convertKeyValueLowerCase = function(e) {
        ...
        Bt = (Et.prototype.removeAlertBox = function() {
            ...
            var r, s, i, a, l = {},
                c = this.getCookie(e);
            if (c)
                for (s = c.split("&"), r = 0; r < s.length; r += 1) i = s[r].split("="), l[decodeURIComponent(i[0])] = i[0] === t && n ? decodeURIComponent(i[1]) : decodeURIComponent(i[1]).replace(/\+/g, " ");
            l[t] = o;
            var d = lt.moduleInitializer.TenantFeatures;
            d && d.CookieV2CookieDateTimeInISO ? l.datestamp = (new Date).toISOString() : l.datestamp = (new Date).toString(), l.version = at.otSDKVersion, a = this.param(l), this.setCookie(e, a, St.ReconsentFrequencyDays)
        }, Et.prototype.readCookieParam = function(e, t, o) {
            var n, r, s, i, a = this.getCookie(e);
            if (a) {
                for (r = {}, s = a.split("&"), n = 0; n < s.length; n += 1) i = s[n].split("="), r[decodeURIComponent(i[0])] = o ? decodeURIComponent(i[1]) : decodeURIComponent(i[1]).replace(/\+/g, " ");
            ...
            if (at.isAMP && (at.ampData = JSON.parse(localStorage.getItem(at.dataDomainId)) || {}, at.ampData)) return at.ampData[e] || null;
            var o, n, r = e + "=",
            ...
            "" !== t ? at.ampData[e] = t : delete at.ampData[e], 0 === Object.keys(at.ampData).length ? this.removeAmpStorage() : this.setAmpStorage()
            ...
            if (void 0 === n && (n = !1), void 0 === r && (r = new Date), at.isAMP) this.handleAmp(e, t);
                ...
                if (at.isPreview || !u && !i.MobileSDK) p = t + s + "; path=/" + l + "; domain=." + a[0] + "; " + d, document.cookie = e + "=" + p;
                else {
                    var p = t + s + "; path=/; " + d;
    ...
    var wt = (xt.insertAfter = function(e, t) {
        ...
        var r = setInterval(function() {
            if (1 <= t.el.length)
                for (var e = 0; e < t.el.length; e++) t.el[e].style.opacity <= 0 && (Tt(t.el[e], "display: none;", !0), clearInterval(r), "optanon-popup-bg" === t.el[e].id && t.el[e].removeAttribute("style"))
        }, e);
        return this
    }, xt.prototype.hide = function() {
        if (1 <= this.el.length)
            for (var e = 0; e < this.el.length; e++) Tt(this.el[e], "display: none;", !0);
        ...
        if ("string" != typeof s)
            ...
            else this.el && (this.el.eventExecuted = !1, !this.el.eventExecuted && this.el instanceof Element && (Ot["" + r + s] || (Ot["" + r + s] = !0, this.el.addEventListener(r, a))))
        }
        return this
        ...
        return (c && "px" === c || "%" === c || "em" === c || "rem" === c) && (0 < d ? Tt(this.el, "height: " + (a + d + c) + ";", !0) : "auto" === e && Tt(this.el, "height: " + e + ";", !0)), this
        ...
        for (var e in this.el = document.querySelector(this.selector), i) l = e,
            function() {
                ...
                if (n ? n.innerHTML += o : ((s = document.createElement("style")).id = "onetrust-legacy-style", s.type = "text/css", s.innerHTML = o, document.head.appendChild(s)), xt.browser().type = xt.browser().version <= 8) {
    ...
    var Gt, Ot = {},
        Nt = (Dt.prototype.addLogoUrls = function() {
            Gt.checkMobileOfflineRequest(Gt.getBannerVersionUrl()) || (At.mobileOnlineURL.push(Gt.updateCorrectUrl(St.optanonLogo)), At.mobileOnlineURL.push(Gt.updateCorrectUrl(St.oneTrustFtrLogo)))
            ...
            for (var a = 0, e = function() {
                    var t = n.SubGroups[a];
                    if (t.Type === dt)(-1 < (e = _t.findIndex(r, function(e) {
            ...
            n.onreadystatechange = function() {
                ...
                o()
            }, n.type = "text/javascript", n.async = !0, n.src = e, at.crossOrigin && n.setAttribute("crossorigin", at.crossOrigin), r.appendChild(n)
            ...
            if (t.length && St.oneTrustFtrLogo) {
                ...
                for (var n = 0; n < t.length; n++) {
                    ...
                    Vt(t[n]).attr("href", St.pCFooterLogoUrl), r.setAttribute("src", o), r.setAttribute("title", s), Vt(t[n]).attr("aria-label", s)
                }
            }
            ...
            return 365 <= e ? (e /= 365, (e = this.round_to_precision(e, .5)) + " " + (1 < e ? St.LfSpnYrs : St.LfSpnYr)) : e + " " + (1 < e ? St.PCenterVendorListLifespanDays : St.PCenterVendorListLifespanDay)
    ...
    var Mt, Ut = new(qt.prototype.initializeBannerVariables = function(e) {
            ...
            At.iabType = o.IabType, t = o.PCTemplateUpgrade, Ht = t ? Ft : Rt, At.init(e), at.showGeneralVendors = St.GeneralVendorsEnabled && St.PCTemplateUpgrade, at.genVenOptOutEnabled = at.showGeneralVendors && St.GenVenOptOut, Gt.addLogoUrls(), this.setGeolocationInCookies(), this.setOrUpdate3rdPartyIABConsentFlag()
            ...
            switch (s[t] || this.initializeVendorInOverriddenVendors(t, !0), s[t].disabledCP || (s[t].disabledCP = []), s[t].disabledLIP || (s[t].disabledLIP = []), r[o]) {
                case D.Disabled:
                    ...
                    break;
                case D.Consent:
                    n ? (s[t].consent = !0, St.Publisher.restrictions[o][t] = D.Consent) : (s[t].disabledLIP.push(o), this.checkFlexiblePurpose(e, t, o, !1));
                    break;
                case D.LegInt:
                    n ? (s[t].disabledCP.push(o), this.checkFlexiblePurpose(e, t, o, !0)) : (s[t].legInt = !0, St.Publisher.restrictions[o][t] = D.LegInt);
                    break;
                case void 0:
                    n ? s[t].consent = !0 : s[t].legInt = !0
            }
        }, qt.prototype.checkFlexiblePurpose = function(e, t, o, n) {
            e.flexiblePurposes.includes(o) ? (n ? St.OverriddenVendors[t].legInt = !0 : St.OverriddenVendors[t].consent = !0, St.Publisher.restrictions[o][t] = n ? D.LegInt : D.Consent) : St.Publisher.restrictions[o][t] = D.Disabled
            ...
            Object.keys(s.vendors).forEach(function(t) {
                ...
                var r = !0;
                At.legIntSettings.PAllowLI && (!o.legIntPurposes.length || St.OverriddenVendors[t] && !St.OverriddenVendors[t].legInt || (r = !1)), !n || !r || o.specialPurposes.length || o.features.length || o.specialFeatures.length || (e = !0), !l && c && o.iab2GVLVersion > a && (e = !0), e && delete s.vendors[t]
            })
            ...
            return l(this, void 0, void 0, function() {
                ...
                return h(this, function(e) {
                    switch (e.label) {
                        case 0:
                            return t = this.iabStringSDK(), o = at.iabData, n = Gt.updateCorrectIABUrl(o.globalVendorListUrl), r = !this.isIABCrossConsentEnabled(), Gt.checkMobileOfflineRequest(Gt.getBannerVersionUrl()) ? [3, 1] : (At.mobileOnlineURL.push(n), s = t.gvl(n, at.gvlObj), [3, 3]);
                        case 1:
                            return a = (i = t).gvl, l = [null], [4, Gt.otFetchOfflineFile(_t.getRelativeURL(n, !0))];
                        case 2:
                            s = a.apply(i, l.concat([e.sent()])), e.label = 3;
                        case 3:
                            return this.removeInActiveVendorsForTcf(s), at.oneTrustIABConsent.vendorList = s, this.assignIABDataWithGlobalVendorList(s), c = at, [4, t.tcModel(s)];
                        case 4:
                            c.tcModel = e.sent(), r && this.setPublisherRestrictions(), at.tcModel.cmpId = parseInt(o.cmpId), at.tcModel.cmpVersion = parseInt(o.cmpVersion);
                            try {
                                at.tcModel.consentLanguage = at.consentLanguage
                            } catch (e) {
                                at.tcModel.consentLanguage = "EN"
                            }
                            return at.tcModel.consentScreen = parseInt(o.consentScreen), at.tcModel.isServiceSpecific = r, at.tcModel.purposeOneTreatment = At.purposeOneTreatment, St.PublisherCC ? at.tcModel.publisherCountryCode = St.PublisherCC : at.userLocation.country && (at.tcModel.publisherCountryCode = at.userLocation.country), at.cmpApi = t.cmpApi(at.tcModel.cmpId, at.tcModel.cmpVersion, r, St.UseGoogleVendors ? {
            ...
            t && (t.addtlConsent = "" + at.addtlConsentVersion + (at.isAddtlConsent ? at.addtlVendors.vendorConsent.join(".") : "")), "function" == typeof e ? e(t, o) : console.error("__tcfapi received invalid parameters.")
            ...
            at.iabData.vendorListVersion = r.vendorListVersion, at.iabData.vendors = [], Object.keys(r.vendors).forEach(function(n) {
                at.vendorsSetting[n] = {
                    consent: !0,
                    legInt: !0,
                    arrIndex: 0,
                ...
                }), at.iabData.vendors.push(e), at.vendorsSetting[n].arrIndex = at.iabData.vendors.length - 1
            })
            ...
            return l(this, void 0, void 0, function() {
                var t, o;
                return h(this, function(e) {
                    return t = window.location.protocol + "//" + n + "/?name=" + r + "&value=" + s + "&expire=" + i + "&isFirstRequest=" + a, document.getElementById("onetrustIabCookie") ? (document.getElementById("onetrustIabCookie").contentWindow.location.replace(t), [2]) : (Tt(o = document.createElement("iframe"), "display: none;", !0), o.id = "onetrustIabCookie", o.setAttribute("title", "OneTrust IAB Cookie"), o.src = t, document.body.appendChild(o), [2, new Promise(function(e) {
                        o.onload = function() {
            ...
            if (void 0 === n && (n = !0), at.iabData.vendors.forEach(function(e) {
                    var t = e.vendorId;
                    if (At.legIntSettings.PAllowLI) {
                        var o = !at.vendorsSetting[t].consent;
                        at.oneTrustIABConsent.vendors.push(t.toString() + ":" + (o ? "false" : n)), at.oneTrustIABConsent.legIntVendors.push(t.toString() + ":" + at.vendorsSetting[t].legInt)
        ...
        jt = (zt.prototype.isAlwaysActiveGroup = function(e) {
            ...
            if (this.getGrpStatus(e)) {
                var t = this.getGrpStatus(e).toLowerCase();
                return e.Parent && t !== we && (t = this.getGrpStatus(this.getParentGroup(e.Parent)).toLowerCase()), t === we || t === Ve || t === xe || t === Oe && !At.DNTEnabled
            }
            return !0
    ...
    var Kt, Wt = (Jt.prototype.ensureConsentId = function(e, t) {
        ...
        if (s.ConsentApi && s.RequestInformation && r.id && !a) {
            ...
            at.isV2Stub && (c.syncGroup = at.syncGrpId, "IAB2" !== At.iabType || Ut.isIABCrossConsentEnabled() || (c.tcStringV2 = Lt.getCookie(Te.EU_PUB_CONSENT)), St.UseGoogleVendors && (c.gacString = Lt.getCookie(Te.ADDITIONAL_CONSENT_STRING)));
            ...
            if (d && this.canSendAdvancedAnalytics(c.purposes, d) && (c.dsDataElements = {
                ...
                e && navigator.sendBeacon ? (navigator.sendBeacon(s.ConsentApi, u), Ut.dispatchConsentEvent()) : !o && at.consentInteractionType === t || (at.isV2Stub && t && this.isAuthUsr(t), wt.ajax({
                    url: s.ConsentApi,
                    type: "post",
                    dataType: "json",
        ...
        e = a && a.purpose ? this.getGrpDetails(a.purpose, b.Purpose) : [], t = a && a.specialFeatures ? this.getGrpDetails(a.specialFeatures, b.SpecialFeature) : [], n = C(a.specialPurposes, a.features), o = C(at.groupsConsent, e, t);
        ...
        return o.forEach(function(e) {
            ...
            if (o && o.PurposeId) {
                var n = void 0;
                n = o.Status === we ? _e : o.Status === Ge && d || r ? Be : o.Status === xe && d ? l ? Ee : Ie : s.getTxnType(t[1]), i.push({
                    Id: o.PurposeId,
                    TransactionType: n
                })
            }
        ...
        }), at.bannerCloseSource = f.Unknown, i
    ...
    var Yt, Xt = ($t.prototype.isIabCookieValid = function() {
        ...
        return l(this, void 0, void 0, function() {
            return h(this, function(e) {
                switch (e.label) {
                    case 0:
                        return St.IsIabEnabled ? (lt.moduleInitializer.otIABModuleData = window.otIabModule, Ut.setIabData(), [4, Ut.populateVendorListTCF()]) : [3, 2];
                    case 1:
                        return e.sent(), Ut.isIABCrossConsentEnabled() || this.iabTypeIsChanged(), Ut.populateIABCookies(), St.UseGoogleVendors && this.removeInActiveAddtlVendors(), [3, 3];
                    case 2:
        ...
        e.vendorConsents.forEach(function(e, t) {
            var o = e;
            at.vendorsSetting[t] && at.vendorsSetting[t].consent || !e || (a.push(t), o = !1), r.vendors.push(t + ":" + o)
        }), e.vendorConsents.unset(a), a = [], e.vendorLegitimateInterests.forEach(function(e, t) {
            var o = e;
            at.vendorsSetting[t] && at.vendorsSetting[t].legInt || !e || (a.push(t), o = !1), r.legIntVendors.push(t + ":" + o)
        ...
        }), e.purposeLegitimateInterests.unset(a), e.publisherLegitimateInterests.unset(a), this.syncBundleAndStack(), e.gvl = at.tcModel.gvl, e.isServiceSpecific = !Ut.isIABCrossConsentEnabled(), at.tcModel = e;
        var t = Ut.iabStringSDK().tcString().encode(e);
        Ut.isAlertBoxClosedAndValid() ? (r.IABCookieValue !== t && (r.IABCookieValue = t, Ut.isIABCrossConsentEnabled() ? Ut.setIAB3rdPartyCookie(Te.EU_CONSENT, r.IABCookieValue, St.ReconsentFrequencyDays, !1) : Lt.setCookie(Te.EU_PUB_CONSENT, r.IABCookieValue, St.ReconsentFrequencyDays)), at.cmpApi.update(t, !1)) : Ut.resetTCModel()
    }, $t.prototype.syncBundleAndStack = function() {
        var e = Lt.readCookieParam(Te.OPTANON_CONSENT, "groups");
        at.groupsConsent = _t.strToArr(e), St.Groups.forEach(function(t) {
            if (t.Type === ct || t.Type === Ct) {
                var e = Gt.isBundleOrStackActive(t),
                    o = _t.findIndex(at.groupsConsent, function(e) {
                        return e.split(":")[0] === t.CustomGroupId
                    }),
                    n = t.CustomGroupId + ":" + Number(e); - 1 < o ? at.groupsConsent[o] = n : at.groupsConsent.push(n)
            }
        ...
        if (St.UseGoogleVendors) {
            ...
            e && (at.isAddtlConsent = !0, at.addtlVendors.vendorConsent = e.replace(at.addtlConsentVersion, "").split("."))
        }
        ...
        t.IABCookieValue = e, t.purpose = t.purpose || [], t.specialFeatures = t.specialFeatures || [], t.legIntVendors = [], t.legimateInterest = t.legimateInterest || [], t.vendors = [], Yt.populateVendorAndPurposeFromCookieData(), Lt.setCookie(Te.EU_PUB_CONSENT, "", -1)
    }, $t);
    ...
    var Qt, Zt = (eo.prototype.writeHstParam = function(e, t) {
        ...
        void 0 === t && (t = null), this.updateGroupsInCookie(e, t), St.IsIabEnabled && Ut.isAlertBoxClosedAndValid() && this.insertOrUpdateIabCookies()
        ...
        if (e.purpose && e.vendors) {
            ...
            var t = St.ReconsentFrequencyDays;
            Ut.isIABCrossConsentEnabled() ? Ut.setIAB3rdPartyCookie(Te.EU_CONSENT, e.IABCookieValue, t, !1) : (Lt.setCookie(Te.EU_PUB_CONSENT, e.IABCookieValue, t), St.UseGoogleVendors && Lt.setCookie(Te.ADDITIONAL_CONSENT_STRING, "" + at.addtlConsentVersion + at.addtlVendors.vendorConsent.join("."), t))
        }
    }, eo);
    ...
    var to, oo = (no.prototype.initGenVendorConsent = function() {
        ...
        if (St.GenVenOptOut) {
            ...
            t ? (at.genVendorsConsent = {}, t.split(",").forEach(function(e) {
                if (e) {
                    var t = e.split(":");
                    "1" === t[1] && (at.genVendorsConsent[t[0]] = !0)
                }
            })) : (at.genVendorsConsent = {}, e.forEach(function(e) {
    ...
    var ro, so = (io.prototype.synchroniseCookieGroupData = function(e) {
        ...
        e.forEach(function(e) {
            ...
            if (-1 === _t.indexOf(l, t)) {
                ...
                var n;
                n = e.Type === ct ? Gt.isBundleOrStackActive(e, a) : (u = !0, Mt.checkIsActiveByDefault(e)), p = !0, a.push(t + (n ? ":1" : ":0"))
            } else {
                if (At.gpcEnabled && e.IsGpcEnabled && (d || c)) - 1 < (s = a.indexOf(t + ":1")) && (p = !0, a[s] = t + ":0");
                else if (At.gpcValueChanged && d) {
                    var r = Mt.checkIsActiveByDefault(e); - 1 < (s = a.indexOf(t + ":" + (r ? "0" : "1"))) && (p = !0, a[s] = t + (r ? ":1" : ":0"))
                }
                if (c && "false" === Ut.getIABCrossConsentflagData() && o) {
                    var s, i = Gt.isBundleOrStackActive(e, a); - 1 < (s = a.indexOf(t + ":" + (i ? "0" : "1"))) && (p = !0, a[s] = t + (i ? ":1" : ":0"))
                }
            }
        });
        ...
        p && (at.fireOnetrustGrp = !0, Qt.updateGroupsInCookie(Te.OPTANON_CONSENT, a), at.syncRequired && u && Lt.removeAlertBox())
    ...
    function uo() {}
    var po, ho = "#onetrust-banner-sdk",
        go = "#onetrust-pc-sdk",
        Co = (yo.prototype.BannerPushDownHandler = function() {
            this.checkIsBrowserIE11OrBelow() || (po.pushPageDown(ho), Vt(window).on("resize", function() {
    ...
    var fo, ko = (vo.prototype.loadBanner = function() {
        ...
        var t = e.toString();
        fo.consentChangedEventMap[t] || (fo.consentChangedEventMap[t] = !0, window.addEventListener("consent.onetrust", e))
        ...
        e ? Lt.setCookie(Te.ALERT_BOX_CLOSED, t, St.ReconsentFrequencyDays) : Lt.setCookie(Te.ALERT_BOX_CLOSED, t, 0), At.pagePushedDown && !po.checkIsBrowserIE11OrBelow() && po.pushPageUp();
        ...
        return l(this, void 0, void 0, function() {
            return h(this, function(e) {
                return t ? (Yt.isInitIABCookieData(t) || Yt.updateFromGlobalConsent(t), "init" === t && (Lt.removeIab1(), Ut.isAlertBoxClosedAndValid() && Ut.resetTCModel(), Lt.removeAlertBox())) : (Ut.resetTCModel(), Ut.updateCrossConsentCookie(!1), Ut.setIABCookieData()), fo.assetPromise.then(function() {
                    fo.loadBanner()
                }), [2]
            })
        })
    ...
    var bo, mo = "opt-out",
        ...
        Wo = (Jo.prototype.getDataLanguageCulture = function() {
            ...
            return at.lang = e, at.consentLanguage = e.substr(0, 2), t = At.canUseConditionalLogic ? At.bannerDataParentURL + "/" + o.Id + "/" + At.Condition.Id + "/" + e : At.bannerDataParentURL + "/" + o.Id + "/" + e, At.multiVariantTestingEnabled && (t = At.bannerDataParentURL + "/" + o.Id + "/variants/" + At.selectedVariant.Id + "/" + e), t
            ...
            if (e) {
                ...
                if (At.multiVariantTestingEnabled && t) {
                    ...
                    o && (n = t[_t.findIndex(t, function(e) {
                        return e.Id === o
                    })]), o && n || (n = t[Math.floor(Math.random() * t.length)]), At.langSwitcherPldr = n.LanguageSwitcherPlaceholder, At.selectedVariant = n
                } else At.canUseConditionalLogic ? At.langSwitcherPldr = At.Condition.LanguageSwitcherPlaceholder : At.langSwitcherPldr = e.LanguageSwitcherPlaceholder
            }
        }, Jo);
    ...
    var Yo, Xo = ($o.prototype.getLangJson = function(e) {
        ...
        return Gt.checkMobileOfflineRequest(Gt.getBannerVersionUrl()) ? Gt.otFetchOfflineFile(_t.getRelativeURL(e, !0)) : (At.mobileOnlineURL.push(e), this.otFetch(e))
        ...
        return l(this, void 0, void 0, function() {
            ...
            return h(this, function(e) {
                switch (e.label) {
                    case 0:
                        return t = St.useRTL ? X.RTL : X.LTR, at.csBtnAsset[t] ? [3, 2] : (o = Gt.getBannerSDKAssestsUrl() + "/" + (St.useRTL ? qe : Re), n = at.csBtnAsset, r = t, [4, this.otFetch(o)]);
                    case 1:
        ...
        return void 0 === i && (i = !1), l(this, void 0, void 0, function() {
            var t, o, n, r, s;
            return h(this, function(e) {
                switch (e.label) {
                    case 0:
                        return t = St.useRTL ? X.RTL : X.LTR, at.pcAsset[t] && !i ? [3, 2] : (o = Gt.getBannerSDKAssestsUrl(), St.PCTemplateUpgrade && (o += "/v2"), n = o + "/" + At.pcName + (St.useRTL ? "Rtl" : "") + ".json", r = at.pcAsset, s = t, [4, this.otFetch(n)]);
                    case 1:
        ...
        return void 0 === s && (s = !1), l(this, void 0, void 0, function() {
            var t, o, n, r;
            return h(this, function(e) {
                switch (e.label) {
                    case 0:
                        return t = St.useRTL ? X.RTL : X.LTR, at.cStyles[t] && !s ? [3, 2] : (o = Gt.getBannerSDKAssestsUrl() + "/otCommonStyles" + (St.useRTL ? "Rtl" : "") + ".css", n = at.cStyles, r = t, [4, this.otFetch(o, !0)]);
                    case 1:
                        n[r] = e.sent(), e.label = 2;
                    case 2:
        ...
        return l(this, void 0, void 0, function() {
            ...
            return h(this, function(e) {
                switch (e.label) {
                    case 0:
                        return t = St.useRTL ? X.RTL : X.LTR, at.syncNtfyContent[t] ? [3, 2] : (o = Gt.getBannerSDKAssestsUrl() + "/otSyncNotification" + (St.useRTL ? "Rtl" : "") + ".json", n = at.syncNtfyContent, r = t, [4, this.otFetch(o)]);
                    case 1:
                        n[r] = e.sent(), e.label = 2;
                    case 2:
            ...
            return h(this, function(e) {
                switch (e.label) {
                    ...
                    case 1:
                        return [2, e.sent()];
                    case 2:
                        return e.trys.push([2, 9, , 10]), At.mobileOnlineURL.push(r), "undefined" != typeof fetch ? [3, 3] : [2, new Promise(function(e) {
    ...
    function $o() {}
    var Qo, Zo = (new lo).assets(),
        en = (tn.prototype.initializeFeaturesAndSpecialPurposes = function() {
            at.oneTrustIABConsent.features = [], at.oneTrustIABConsent.specialPurposes = [], St.Groups.forEach(function(e) {
                if ("IAB2_FEATURE" === e.Type || "IAB2_SPL_PURPOSE" === e.Type) {
                    var t = {};
                    t.groupId = e.OptanonGroupId, t.purposeId = e.PurposeId, t.value = !0, "IAB2_FEATURE" === e.Type ? at.oneTrustIABConsent.features.push(t) : at.oneTrustIABConsent.specialPurposes.push(t)
                }
            })
        }, tn.prototype.initGrpsAndHosts = function() {
            this.initializeGroupData(At.consentableGrps), St.showCookieList && Gt.isOptOutEnabled() ? this.initializeHostData(At.consentableGrps) : (at.hostsConsent = [], Qt.writeHstParam(Te.OPTANON_CONSENT))
        }, tn.prototype.ensureHtmlGroupDataInitialised = function() {
            if (this.initGrpsAndHosts(), at.showGeneralVendors && (to.populateGenVendorLists(), to.initGenVendorConsent()), St.IsIabEnabled && (this.initializeIABData(), this.initializeFeaturesAndSpecialPurposes()), Ut.setOrUpdate3rdPartyIABConsentFlag(), Ut.setGeolocationInCookies(), St.IsConsentLoggingEnabled) {
            ...
            var t = Lt.readCookieParam(Te.OPTANON_CONSENT, "groups");
            t ? (ro.synchroniseCookieGroupData(e), t = Lt.readCookieParam(Te.OPTANON_CONSENT, "groups"), at.groupsConsent = _t.strToArr(t)) : (at.groupsConsent = [], e.forEach(function(e) {
            ...
            if (t) ro.synchroniseCookieHostData(), t = Lt.readCookieParam(Te.OPTANON_CONSENT, "hosts"), at.hostsConsent = _t.strToArr(t), e.forEach(function(e) {
            ...
            !isNaN(e) && 0 !== e || (fo.triggerGoogleAnalyticsEvent(Po, "Click", "No interaction"), St.IsConsentLoggingEnabled && Kt.createConsentTxn(!0), window.removeEventListener("beforeunload", Qo.consentDefaulCall))
                    ...
                    switch (e.label) {
                        ...
                        case 1:
                            return p = e.sent(), t = p[0], o = p[1], n = p[2], r = p[3], t && (u = t.html, lt.fp.CookieV2SSR || (u = atob(t.html)), this.bannerGroup = {
                                ...
                                html: atob(o.html),
                                css: o.css
                            }, lt.isV2Template = St.PCTemplateUpgrade && /otPcPanel|otPcCenter|otPcTab/.test(o.name)), r && (this.commonStyles = r), this.cookieListGroup = {
                                name: Zo.name,
                                html: Zo.html,
            ...
            var e = at.oneTrustIABConsent;
            if (e.purpose = [], e.vendors = [], e.legIntVendors = [], e.specialFeatures = [], e.legimateInterest = [], at.addtlVendors.vendorConsent = [], !e.IABCookieValue || o || n || Ut.reconsentRequired()) {
                At.consentableIabGrps.forEach(function(e) {
            ...
            } else this.initializeIabPurposeConsentOnReload(), Yt.populateGoogleConsent(), Yt.populateVendorAndPurposeFromCookieData()
            ...
            e.Type === ht ? this.setIabSpeciFeatureConsent(e, t) : e.IsLegIntToggle ? (this.setIabLegIntConsent(e, t), e.IsLegIntToggle = !1) : this.setIabPurposeConsent(e, t)
    ...
    var sn, an = (ln.prototype.setBannerFocus = function() {
        ...
        At.bannerName === Je ? (s = Array.prototype.concat.call(d, s), c = Array.prototype.slice.call(Vt("#onetrust-banner-sdk #onetrust-button-group button").el)) : s = Array.prototype.concat.call(s, d), this.bannerEl = Array.prototype.concat.call(Array.prototype.slice.call(Vt("#onetrust-banner-sdk #onetrust-cookie-btn").el), s, Array.prototype.slice.call(Vt("#onetrust-banner-sdk .banner-option-input").el), c, Array.prototype.slice.call(Vt("#onetrust-banner-sdk .ot-bnr-footer-logo a").el), i), this.banner = Vt("#onetrust-banner-sdk").el[0], (St.BInitialFocus || St.BInitialFocusLinkAndButton || St.ForceConsent) && (St.BInitialFocus ? this.banner.focus() : this.bannerEl[0].focus())
        ...
        var o = e.target,
            ...
            s = n.length - 1,
            i = null;
        if (!St.ForceConsent && (St.BInitialFocus || St.BInitialFocusLinkAndButton) && (t && 0 === r || !t && r === s)) Gt.resetFocusToBody();
        ...
        if (e && !(e.length <= 0)) {
            ...
            this.firstItem ? o ? n.focus(r) : this.firstItem.focus(r) : e[0].focus(), this.firstItem && Vt(this.firstItem).on("keydown", sn.firstItemHandler), this.lastItem && Vt(this.lastItem).on("keydown", sn.lastItemHandler)
        }
        ...
        t !== this.lastItem && (Vt(this.lastItem).off("keydown", sn.lastItemHandler), this.lastItem = t, Vt(t).on("keydown", sn.lastItemHandler))
        ...
        return at.pcLayer === T.CookieList ? e += " ,#onetrust-pc-sdk " + Ht.P_Content + " .powered-by-logo" : e += ",#onetrust-pc-sdk #vendor-list-save-btn .powered-by-logo", Array.prototype.slice.call(Vt(e).el)
    ...
    var cn, dn = (un.prototype.getAllGroupElements = function() {
        ...
        for (var n = e.querySelectorAll('input[class*="category-switch-handler"]'), r = 0; r < n.length; r++) _t.setCheckedAttribute(null, n[r], o), n[r] && St.PCShowConsentLabels && (n[r].parentElement.parentElement.querySelector(".ot-label-status").innerHTML = o ? St.PCActiveText : St.PCInactiveText);
        ...
        void 0 === o && (o = !1), void 0 === n && (n = !1), At.pcName === et && St.PCTemplateUpgrade && (e = document.querySelector("#ot-desc-id-" + e.getAttribute("data-optanongroupid")));
        ...
        if (-1 < kt.indexOf(e.Type)) this.updateIabGroupData(e, !0);
            ...
            var t = cn.getGroupVariable(),
                o = _t.indexOf(t, e.CustomGroupId + ":0"); - 1 !== o && (t[o] = e.CustomGroupId + ":1")
        }
    }, un.prototype.updateDisabledGroupData = function(e) {
        if (-1 < kt.indexOf(e.Type)) this.updateIabGroupData(e, !1);
        else if (e.Status !== we) {
            var t = cn.getGroupVariable(),
                o = _t.indexOf(t, e.CustomGroupId + ":1"); - 1 !== o && (t[o] = e.CustomGroupId + ":0")
        }
        ...
        _t.setCheckedAttribute(null, r, o), r && St.PCShowConsentLabels && (r.parentElement.querySelector(".ot-label-status").innerHTML = o ? St.PCActiveText : St.PCInactiveText)
        ...
        t ? (n.classList.add("ot-inactive-leg-btn"), n.classList.add("ot-leg-int-enabled"), n.classList.remove("ot-active-leg-btn")) : (n.classList.add("ot-active-leg-btn"), n.classList.remove("ot-inactive-leg-btn"), n.classList.remove("ot-leg-int-enabled")), n.querySelector("span").innerText = t ? o.PObjectLegIntText : o.PObjectionAppliedText, Tt(r, "display: " + (t ? "none" : "inline-block") + ";", !0)
        ...
        var t = 0,
            e = St.Groups.some(function(e) {
                if (-1 === vt.indexOf(e.Type)) return cn.IsGroupInActive(e) && t++, e.SubGroups.some(function(e) {
                    return cn.IsGroupInActive(e)
                }) && t++, 1 <= t
            }),
        ...
        var t;
        return t = e.Type === ht ? at.vendors.selectedSpecialFeatures : e.IsLegIntToggle ? at.vendors.selectedLegInt : at.vendors.selectedPurpose, wt.inArray(e.IabGrpId + ":true", t)
    ...
    var pn, hn = (gn.prototype.insertCookiePolicyHtml = function() {
        if (Vt(this.ONETRUST_COOKIE_POLICY).length) {
            ...
            for (var l = 0; l < St.Groups.length; l++)
                ...
                for (var c = 0; c < St.Groups[l].SubGroups.length; c++) this.insertGroupHTML(St, St.Groups[l].SubGroups, i, c, a, e, t)
        }
        ...
        if (e[o].ShowSubgroup && p.length) {
            ...
            p.forEach(function(e) {
                var t = y.cloneNode(!0);
                h = h.concat(e.Hosts), g = g.concat(e.FirstPartyCookies), (e.Hosts.length || e.FirstPartyCookies.length) && (C += "," + e.GroupName), Vt(t.querySelector(".ot-sdk-cookie-policy-group")).html(e.GroupName), Vt(t.querySelector(".ot-sdk-cookie-policy-group-desc")).html(i.groupsClass.safeFormattedGroupDescription(e)), Vt(y.parentElement).append(t)
            }), u.querySelector("section.ot-sdk-subgroup ul").removeChild(y)
        } else u.removeChild(u.querySelector("section.ot-sdk-subgroup"));
        a.IsLifespanEnabled ? Vt(d("th.ot-life-span")).el.innerHTML = a.LifespanText : Vt(d("thead tr")).el.removeChild(Vt(d("th.ot-life-span")).el), Vt(d("th.ot-cookies")).el.innerHTML = a.CookiesText, Vt(d("th.ot-host")).el.innerHTML = a.CategoriesText, Vt(d("th.ot-cookies-type")).el.innerHTML = a.CookiesUsedText;
        var f = this.transformFirstPartyCookies(g, h, s),
            k = !1;
        f.some(function(e) {
            return e.Description
        }) ? k = !0 : Vt(d("thead tr")).el.removeChild(Vt(d("th.ot-host-description")).el), Vt(d(".ot-sdk-cookie-policy-group")).html(s.GroupName), Vt(d(".ot-sdk-cookie-policy-group-desc")).html(this.groupsClass.safeFormattedGroupDescription(s));
        for (var v = function(e) {
                function t(e) {
                    return o.querySelector(e)
                }
                var o = l.cloneNode(!0);
                Vt(t(".ot-cookies-td span")).text(""), Vt(t(".ot-life-span-td span")).text(""), Vt(t(".ot-cookies-type span")).text(""), Vt(t(".ot-cookies-td .ot-cookies-td-content")).html(""), Vt(t(".ot-host-td")).html(""), Vt(t(".ot-host-description-td")).html('<span class="ot-mobile-border"></span><p>' + f[e].Description + "</p> ");
                for (var n = [], r = [], s = 0; s < f[e].Cookies.length; s++)(c = f[e].Cookies[s]).IsSession ? n.push(a.LifespanTypeText) : n.push(Gt.getDuration(c)), r.push(f[e].Type ? '<a href="https://cookiepedia.co.uk/cookies/' + c.Name + '" rel="noopener" target="_blank" aria-label="' + c.Name + " " + St.NewWinTxt + '">' + c.Name + "</a>" : c.Name);
                Vt(t(".ot-host-td")).append('<span class="ot-mobile-border"></span>'), t(".ot-host-td").setAttribute("data-label", a.CategoriesText), t(".ot-cookies-td").setAttribute("data-label", a.CookiesText), t(".ot-cookies-type").setAttribute("data-label", a.CookiesUsedText), t(".ot-life-span-td").setAttribute("data-label", a.LifespanText);
                var i = f[e].DisplayName || f[e].HostName;
                Vt(t(".ot-host-td")).append(f[e].Type ? i : '<a href="https://cookiepedia.co.uk/host/' + c.Host + '" rel="noopener" target="_blank" aria-label="' + i + " " + St.NewWinTxt + '">' + i + "</a>"), t(".ot-cookies-td .ot-cookies-td-content").insertAdjacentHTML("beforeend", r.join(", ")), t(".ot-life-span-td .ot-life-span-td-content").innerText = n.join(", "), t(".ot-cookies-type .ot-cookies-type-td-content").innerText = f[e].Type ? St.firstPartyTxt : St.thirdPartyTxt, a.IsLifespanEnabled || o.removeChild(t("td.ot-life-span-td")), k || o.removeChild(t("td.ot-host-description-td")), Vt(d("tbody")).append(o)
            }, b = 0; b < f.length; b++) v(b);
        0 === f.length ? u.removeChild(u.querySelector("table")) : Vt(d("caption")).el.innerHTML = C, Vt(n).append(u), Vt(r).append(n), Vt("#ot-sdk-cookie-policy").append(r)
        ...
        s = e[o];
        var p = t.cloneNode(!0);
        Vt(u("caption")).el.innerHTML = s.GroupName, Vt(u("tbody")).html(""), Vt(u("thead tr")), a.IsLifespanEnabled ? Vt(u("th.life-span")).el.innerHTML = a.LifespanText : Vt(u("thead tr")).el.removeChild(Vt(u("th.life-span")).el), Vt(u("th.cookies")).el.innerHTML = a.CookiesText, Vt(u("th.host")).el.innerHTML = a.CategoriesText;
        var h = !1;
        if (s.Hosts.some(function(e) {
                return e.description
            }) ? h = !0 : Vt(u("thead tr")).el.removeChild(Vt(u("th.host-description")).el), Vt(u(".ot-sdk-cookie-policy-group")).html(s.GroupName), Vt(u(".ot-sdk-cookie-policy-group-desc")).html(this.groupsClass.safeFormattedGroupDescription(s)), 0 < s.FirstPartyCookies.length) {
            Vt(u(".cookies-used-header")).html(a.CookiesUsedText), Vt(u(".cookies-list")).html("");
            for (var g = 0; g < s.FirstPartyCookies.length; g++) i = s.FirstPartyCookies[g], Vt(u(".cookies-list")).append("<li> " + Gt.getCookieLabel(i, a.AddLinksToCookiepedia) + " <li>")
        ...
        for (var C = function(e) {
                ...
                var o = l.cloneNode(!0);
                Vt(t(".cookies-td ul")).html(""), Vt(t(".life-span-td ul")).html(""), Vt(t(".host-td")).html(""), Vt(t(".host-description-td")).html('<span class="ot-mobile-border"></span><p>' + c[e].Description + "</p> ");
                for (var n = 0; n < c[e].Cookies.length; n++) {
                    ...
                    0 === n && (Vt(t(".host-td")).append('<span class="ot-mobile-border"></span>'), Vt(t(".host-td")).append('<a href="https://cookiepedia.co.uk/host/' + d.Host + '" rel="noopener" target="_blank"\n                        aria-label="' + (c[e].DisplayName || c[e].HostName) + " " + St.NewWinTxt + '">' + (c[e].DisplayName || c[e].HostName) + "</a>"))
                }
                h || o.removeChild(t("td.host-description-td")), Vt(u("tbody")).append(o)
            }, y = 0; y < c.length; y++) C(y);
        0 === c.length && Vt(u("table")).el.removeChild(Vt(u("thead")).el), Vt(n).append(p), Vt(r).append(n), Vt("#ot-sdk-cookie-policy").append(r)
    ...
    var fn, kn = (vn.prototype.updateFilterSelection = function(e) {
        var t, o;
        void 0 === e && (e = !1), o = e ? (t = at.filterByCategories, "data-optanongroupid") : (t = at.filterByIABCategories, "data-purposeid");
        ...
        at.hosts.hostTemplate = Vt(Ht.P_Vendor_List + " " + Ht.P_Host_Cntr + " li").el[0].cloneNode(!0), at.hosts.hostCookieTemplate = Vt(Ht.P_Vendor_List + " " + Ht.P_Host_Cntr + " " + Ht.P_Host_Opt + " li").el[0].cloneNode(!0)
    ...
    var bn, mn = (Pn.prototype.getSearchQuery = function(e) {
        ...
        if (o) {
            ...
            r !== n.length ? e.forEach(function(o) {
                i = !0, o.vendorName && n.forEach(function(e) {
                    var t = parseInt(At.iabGrpIdMap[e]); - 1 < e.indexOf("IFEV2_") ? (o.features || []).forEach(function(e) {
        ...
        void 0 === e && (e = "");
        var o = at.vendors;
        at.currentGlobalFilteredList = o.list, e ? (o.searchParam = e, at.filterByIABCategories = [], fn.updateFilterSelection(!1)) : o.searchParam !== e ? o.searchParam = "" : t = at.filterByIABCategories;
        ...
        if (n) {
            ...
            for (var i in t)
                if (i) {
                    ...
                    r.lastIndex = 0, r.test(t[i][e.name]) ? (Tt(l, this._displayNull, !0), s++) : Tt(l, "display: none;", !0)
                }
            0 === s ? (Vt(e.accId).hide(), o === Q.GoogleVendor ? this.hasGoogleVendors = !1 : this.hasGenVendors = !1) : (o === Q.GoogleVendor ? this.hasGoogleVendors = !0 : this.hasGenVendors = !0, Vt(e.accId).show()), this.showEmptyResults(!this.hasGoogleVendors && !this.hasIabVendors && !this.hasGenVendors, n)
        } else
            for (var c = Vt(" " + e.venListId + ' li[style^="display: none"]').el, d = 0; d < c.length; d++) Tt(c[d], this._displayNull, !0);
        var u = Vt("#onetrust-pc-sdk " + e.selectAllEvntHndlr).el[0];
        document.querySelector(e.venListId + ' li:not([style^="display: none"]) ' + e.ctgl + " > input[checked]") ? _t.setCheckedAttribute("", u, !0) : _t.setCheckedAttribute("", u, !1), document.querySelector(e.venListId + ' li:not([style^="display: none"]) ' + e.ctgl + " > input:not([checked])") ? u.parentElement.classList.add("line-through") : u.parentElement.classList.remove("line-through")
        ...
        this.populateGeneralVendors(), St.GenVenOptOut && St.GeneralVendors && St.GeneralVendors.length && this.genVenSelectAllTglEvent()
        ...
        e ? this.setNoResultsContent(t, o) : (Vt("#onetrust-pc-sdk " + Ht.P_Vendor_Content).removeClass("no-results"), n.length && n.remove())
        ...
        if (!o) {
            ...
            return n.id = "no-results", i.id = "user-text", i.innerText = e, r.appendChild(i), r.appendChild(s), n.appendChild(r), Vt("#onetrust-pc-sdk " + Ht.P_Vendor_Content).addClass("no-results"), Vt("#vendor-search-handler").el[0].setAttribute("aria-describedby", n.id), Vt("#onetrust-pc-sdk " + Ht.P_Vendor_Content).append(n)
        }
        ...
        St.showCookieList && !St.GeneralVendorsEnabled && (e = St.PCenterCookieSearchAriaLabel, t = St.PCenterCookieListSearch, o = St.PCenterCookiesListText), document.querySelector("#onetrust-pc-sdk " + Ht.P_Vendor_Title).innerText = o;
        ...
        var p = lt.isV2Template,
            ...
            C = !1;
        this.setBackBtnTxt(), Vt(Ht.P_Vendor_List + " #select-all-text-container p").html(St.PCenterAllowAllConsentText), Vt("#onetrust-pc-sdk " + Ht.P_Vendor_Content + " ul" + Ht.P_Host_Cntr).html(""), this.showEmptyResults(d && 0 === d.length, e, !0), !lt.isV2Template && h === et || this.setListSearchValues(), Vt("#filter-btn-handler").el[0].setAttribute(this.ARIA_LABEL_ATTRIBUTE, St.PCenterCookieListFilterAria), Vt("#filter-btn-handler title").html(St.PCenterCookieListFilterAria), lt.isV2Template && Vt("#ot-sel-blk span:first-child").html(St.PCenterAllowAllConsentText || St.ConsentText);
        for (var t = function(o) {
                ...
                if (r && _t.setHtmlAttributes(r, {
                    ...
                    var i = void 0;
                    p ? ((i = Cn.chkboxEl.cloneNode(!0)).classList.add("ot-host-tgl"), i.querySelector("input").classList.add("host-checkbox-handler"), h === et ? n.querySelector(Ht.P_Host_Hdr).insertAdjacentElement("beforeBegin", i) : n.querySelector(Ht.P_Tgl_Cntr).insertAdjacentElement("beforeEnd", i)) : i = n.querySelector(".ot-host-tgl"), _t.setHtmlAttributes(i.querySelector("input"), {
                        id: "ot-host-chkbox-" + o,
                        "aria-label": t,
                        hostId: d[o].HostId,
                        ckType: d[o].Type
                    }), i.querySelector("label").setAttribute("for", "ot-host-chkbox-" + o), (d[o].Type === U.GenVendor ? at.genVendorsConsent[d[o].HostId] : -1 !== at.hostsConsent.indexOf(d[o].HostId + ":1")) ? (_t.setCheckedAttribute(null, i.querySelector("input"), !0), d[o].isActive ? _t.setDisabledAttribute(null, i.querySelector("input"), !0) : C = C || !0) : (C = !0, _t.setCheckedAttribute(null, i.querySelector("input"), !1)), i.querySelector(Ht.P_Label_Txt).innerText = t
                }
                if (St.PCAccordionStyle === W.PlusMinus) n.querySelector(Ht.P_Acc_Header).insertAdjacentElement("afterBegin", Cn.plusMinusEl.cloneNode(!0));
                else if (p) {
                ...
                St.AddLinksToCookiepedia && !d[o].isFirstParty && (t = '\n                    <a  class="cookie-label"\n                        href="http://cookiepedia.co.uk/host/' + d[o].HostName + '"\n                        rel="noopener"\n                        target="_blank"\n                    >\n                        ' + t + '&nbsp;<span class="ot-scrn-rdr">' + St.NewWinTxt + "</span>\n                    </a>\n                "), n.querySelector(Ht.P_Host_Title).innerHTML = t, n.querySelector(Ht.P_Host_Desc).innerHTML = d[o].Description, d[o].PrivacyPolicy && St.pcShowCookieHost && n.querySelector(Ht.P_Host_Desc).insertAdjacentHTML("afterend", '<a href="' + d[o].PrivacyPolicy + '" rel="noopener" target="_blank">' + (p ? St.PCGVenPolicyTxt : St.PCCookiePolicyText) + '&nbsp;<span class="ot-scrn-rdr">' + St.NewWinTxt + "</span></a>");
                var l = n.querySelector(Ht.P_Host_View_Cookies);
                if (at.showGeneralVendors && !d[o].Cookies.length ? (_t.removeChild(l), Vt(n).addClass("ot-hide-acc")) : St.PCViewCookiesText && (l.innerHTML = St.PCViewCookiesText), !d[o].Description || !St.pcShowCookieHost) {
                    var c = n.querySelector(Ht.P_Host_Desc);
                    c.parentElement.removeChild(c)
                }
                Vt(n.querySelector(Ht.P_Host_Opt)).html(""), d[o].Cookies.forEach(function(e) {
        ...
        if (Gt.isOptOutEnabled() && !n) {
            ...
            for (var r = Vt("#onetrust-pc-sdk " + Ht.P_Host_Cntr + " .ot-host-tgl input").el, s = 0; s < r.length; s++) r[s].addEventListener("click", this.hostsListEvent);
        ...
        _t.setCheckedAttribute("", o, o.checked), o && n && o.setAttribute(this.ARIA_LABEL_ATTRIBUTE, n.textContent + " " + St.PCenterSelectAllVendorsText)
        ...
        if (!a && St.PCenterVendorListDescText)
            if ((a = document.createElement("p")).id = "vdr-lst-dsc", Vt(a).html(St.PCenterVendorListDescText), At.pcName !== et && At.pcName !== $e) {
        ...
        Vt("#onetrust-pc-sdk " + Ht.P_Select_Cntr).removeClass("ot-hide"), this.vendorsListEvent(), At.legIntSettings.PAllowLI && this.vendorLegIntToggleEvent()
        ...
        i && (i.parentElement.classList.remove("line-through"), _t.setCheckedAttribute("", i, e)), St.UseGoogleVendors && this.updateGoogleCheckbox(e), at.showGeneralVendors && St.GenVenOptOut && this.updateGenVenCheckbox(e)
    }, Pn.prototype.updateGenVenCheckbox = function(e) {
        for (var t = Vt(Ht.P_Gven_List + " .ot-ven-gvctgl input").el, o = 0; o < t.length; o++) _t.setCheckedAttribute("", t[o], e);
        ...
        for (var t = Vt("#ot-addtl-venlst .ot-tgl-cntr input").el, o = 0; o < t.length; o++) _t.setCheckedAttribute("", t[o], e);
        ...
        if (t && t.disclosures) {
            var r = o.querySelector(Ht.P_Ven_Dets),
                ...
                n = s.cloneNode(!0);
            n.innerHTML = "<p><b>" + St.PCenterVendorListDisclosure + ": </b></p>", r.insertAdjacentElement("beforeend", n), t.disclosures.forEach(function(e) {
                var t = s.cloneNode(!0),
                    o = "<p>" + St.PCenterVendorListStorageIdentifier + " </p> <p>" + (e.name || e.identifier) + " </p>";
                if (e.type && (o += "<p>" + St.PCenterVendorListStorageType + " </p> <p>" + e.type + " </p>"), e.maxAgeSeconds) {
                    var n = _t.calculateCookieLifespan(e.maxAgeSeconds);
                    o += "<p>" + St.PCenterVendorListLifespan + " </p> <p>" + n + " </p>"
                }
                e.domain && (o += "<p>" + St.PCenterVendorListStorageDomain + " </p> <p>" + e.domain + " </p>"), e.purposes && (o += "<p>" + St.PCenterVendorListStoragePurposes + " </p> <p>" + e.purposes + " </p>"), t.innerHTML = o, r.insertAdjacentElement("beforeend", t)
            })
        }
        ...
        var R, q, M = at.vendors.list,
            U = St.IabType,
            j = At.pcName,
            z = at.vendors.vendorTemplate.cloneNode(!0);
        at.discVendors = {}, lt.isV2Template && (R = z.querySelector(".ot-ven-pur").cloneNode(!0), q = z.querySelector(Ht.P_Ven_Disc).cloneNode(!0), Vt(z.querySelector(".ot-ven-dets")).html(""));
        for (var e = function(e) {
                ...
                _t.setHtmlAttributes(r, {
                    ...
                    "aria-label": n
                }), r.nextElementSibling.setAttribute("for", "IAB" + o), t.querySelector(Ht.P_Ven_Name).innerText = n, _t.setHtmlAttributes(i, {
                    href: M[e].policyUrl,
                    rel: "noopener",
                    target: "_blank"
                ...
                if (s.consent) {
                    ...
                    _t.setCheckedAttribute("", h, p), _t.setHtmlAttributes(h, {
                        id: Ht.P_Vendor_CheckBx + "-" + e,
                        vendorid: o,
                        "aria-label": n
                    }), c.querySelector("label").setAttribute("for", Ht.P_Vendor_CheckBx + "-" + e), c.querySelector(Ht.P_Label_Txt).textContent = n, j === et ? St.PCTemplateUpgrade ? d.insertAdjacentElement("beforeend", c) : Vt(d).append(c) : d.insertBefore(c, u)
                }
                if (s.legInt && !s.specialPurposesOnly) {
                    ...
                    } else h = l.querySelector("input"), lt.isV2Template && (h.classList.add("vendor-checkbox-handler"), g = l.querySelector(".ot-label-status"), St.PCShowConsentLabels ? g.innerHTML = C ? St.PCActiveText : St.PCInactiveText : _t.removeChild(g)), l.classList.add(Ht.P_Ven_Ltgl), h.classList.remove("vendor-checkbox-handler"), h.classList.add("vendor-leg-checkbox-handler"), _t.setCheckedAttribute("", h, C), _t.setHtmlAttributes(h, {
                        id: Ht.P_Vendor_LegCheckBx + "-" + e,
                        "leg-vendorid": o,
                        "aria-label": n
                    }), l.querySelector("label").setAttribute("for", Ht.P_Vendor_LegCheckBx + "-" + e), l.querySelector(Ht.P_Label_Txt).textContent = n, t.querySelector("." + Ht.P_Ven_Ctgl) && (u = t.querySelector("." + Ht.P_Ven_Ctgl)), j !== et || d.children.length ? d.insertBefore(l, u) : Vt(d).append(l), s.consent || j !== et || l.classList.add(Ht.P_Ven_Ltgl_Only)
                }
                lt.isV2Template && (d.insertAdjacentElement("beforeend", Cn.arrowEl.cloneNode(!0)), St.PCAccordionStyle !== W.Caret && t.querySelector(".ot-ven-hdr").insertAdjacentElement("beforebegin", Cn.plusMinusEl.cloneNode(!0)));
                ...
                if (k && _t.setHtmlAttributes(k, {
                    ...
                    }), lt.isV2Template) K.populateVendorDetailsHtml(t, R, M[e], q);
                else {
                    ...
                    var G = t.querySelector(Ht.P_Ven_Dets),
                        O = q.cloneNode(!0);
                    q.parentElement.removeChild(q), K.attachVendorDisclosure(O, M[e]), G.insertAdjacentElement("afterbegin", O), b.parentElement.removeChild(b), s.consent && (Vt(v.querySelector("p")).text(St.ConsentPurposesText), M[e].purposes.forEach(function(e) {
                    ...
                    "IAB2" === St.IabType && N.parentElement.removeChild(N), P.parentElement.removeChild(P), s.legInt && (Vt(m.querySelector("p")).text(St.LegitimateInterestPurposesText), At.legIntSettings.PAllowLI && "IAB2" === St.IabType && M[e].legIntPurposes.forEach(function(e) {
                        Vt(E.querySelector(".consent-category")).text(e.purposeName), m.insertAdjacentHTML("afterend", E.outerHTML)
                    })), s.legInt || m.parentElement.removeChild(m), S.parentElement.removeChild(S), "IAB2" === U && M[e].specialPurposes.forEach(function(e) {
                        Vt(w.querySelector(".consent-category")).text(e.purposeName), A.insertAdjacentHTML("afterend", w.outerHTML)
                    }), 0 === M[e].specialPurposes.length ? A.parentElement.removeChild(A) : Vt(A.querySelector("p")).text(St.SpecialPurposesText), I.parentElement.removeChild(I), Vt(T.querySelector("p")).text(St.FeaturesText), M[e].features.forEach(function(e) {
                        Vt(x.querySelector(".consent-category")).text(e.featureName), T.insertAdjacentHTML("afterend", x.outerHTML)
                        ...
                        Vt(V.querySelector(".consent-category")).text(e.featureName), L.insertAdjacentHTML("afterend", V.outerHTML)
        ...
        if (at.vendors.list = at.iabData ? at.iabData.vendors : null, at.vendors.vendorTemplate = Vt(Ht.P_Vendor_Container + " li").el[0].cloneNode(!0), Vt("#onetrust-pc-sdk " + Ht.P_Vendor_Container).html(""), !lt.isV2Template && At.pcName === et) {
        ...
        var t = St.PCAccordionStyle === W.Caret ? Cn.arrowEl.cloneNode(!0) : Cn.plusMinusEl.cloneNode(!0),
            ...
            n = o.cloneNode(!0);
        _t.removeChild(n.querySelector("#ot-selall-hostcntr")), _t.removeChild(o.querySelector("#ot-selall-vencntr")), _t.removeChild(o.querySelector("#ot-selall-licntr"));
        ...
        var s = n.cloneNode(!0);
        _t.removeChild(s.querySelector("#ot-selall-licntr")), s.querySelector(".ot-chkbox").id = "ot-selall-adtlvencntr", s.querySelector("input").id = "ot-selall-adtlven-handler", s.querySelector("label").setAttribute("for", "ot-selall-adtlven-handler");
        var i = Cn.accordionEl.cloneNode(!0);
        i.querySelector(".ot-acc-hdr").insertAdjacentElement("beforeEnd", t.cloneNode(!0)), i.querySelector(".ot-acc-hdr").insertAdjacentHTML("beforeEnd", "<div class='ot-vensec-title'>" + St.PCGoogleVendorsText + "</div>"), i.querySelector(".ot-acc-hdr").insertAdjacentElement("beforeEnd", s), i.querySelector(".ot-acc-txt").insertAdjacentHTML("beforeEnd", "<ul id='ot-addtl-venlst'></ul>"), i.classList.add("ot-adtlv-acc"), i.querySelector("button").setAttribute(this.ARIA_LABEL_ATTRIBUTE, St.PCGoogleVendorsText);
        var a = at.vendors.vendorTemplate.cloneNode(!0);
        for (var l in a.querySelector("button").classList.remove("ot-ven-box"), a.querySelector("button").classList.add("ot-addtl-venbox"), _t.removeChild(a.querySelector(".ot-acc-txt")), e)
            if (e[l]) {
                var c = a.cloneNode(!0),
                    d = e[l].name;
                ...
                St.PCShowConsentLabels ? C.innerHTML = h ? St.PCActiveText : St.PCInactiveText : _t.removeChild(C), _t.setCheckedAttribute("", g, h), _t.setHtmlAttributes(g, {
                    id: "ot-addtlven-chkbox-" + l,
                    "addtl-vid": l,
                    "aria-label": d
                }), p.querySelector("label").setAttribute("for", "ot-addtlven-chkbox-" + l), p.querySelector(Ht.P_Label_Txt).textContent = d;
                var y = c.querySelector(Ht.P_Tgl_Cntr);
                Vt(y).append(p), y.insertAdjacentElement("beforeend", Cn.arrowEl.cloneNode(!0)), St.PCAccordionStyle !== W.Caret && c.querySelector(".ot-ven-hdr").insertAdjacentElement("beforebegin", Cn.plusMinusEl.cloneNode(!0)), Vt(i.querySelector("#ot-addtl-venlst")).append(c)
            }
        Vt("#ot-lst-cnt .ot-sdk-column").append(i), Vt("#onetrust-pc-sdk").on("click", "#ot-pc-lst .ot-acc-cntr > input", function(e) {
        ...
        e.forEach(function(e) {
            ...
            if (_t.setHtmlAttributes(i, {
                    ...
                    rel: "noopener",
                    target: "_blank"
                }), s.innerHTML = St.PCGVenPolicyTxt + "&nbsp;<span class='ot-scrn-rdr'>" + r + " " + St.NewWinTxt + "</span>") : s.classList.add("ot-hide"), p.addDescriptionElement(s, e.Description), St.GenVenOptOut) {
                ...
                St.PCShowConsentLabels ? d.innerHTML = l ? St.PCActiveText : St.PCInactiveText : _t.removeChild(d), _t.setCheckedAttribute("", c, l), _t.setHtmlAttributes(c, {
                    id: "ot-gnven-chkbox-" + t,
                    "gn-vid": t,
                    "aria-label": r
                }), to.isGenVenPartOfAlwaysActiveGroup(t) ? _t.setDisabledAttribute(null, c, !0) : y = !1, a.querySelector("label").setAttribute("for", "ot-gnven-chkbox-" + t), a.querySelector(Ht.P_Label_Txt).textContent = r;
                var u = n.querySelector(Ht.P_Tgl_Cntr);
                Vt(u).append(a), u.insertAdjacentElement("beforeend", Cn.arrowEl.cloneNode(!0))
            }
            St.PCAccordionStyle !== W.Caret && n.querySelector(".ot-ven-hdr").insertAdjacentElement("beforebegin", Cn.plusMinusEl.cloneNode(!0)), e.Cookies.length || Vt(n).addClass("ot-hide-acc"), e.Cookies.forEach(function(e) {
        ...
        }), h || Vt("#ot-lst-cnt .ot-sdk-column").append(g), Vt("#onetrust-pc-sdk").on("click", "#ot-pc-lst .ot-acc-cntr > input", function(e) {
            _t.setCheckedAttribute(null, e.target, e.target.checked)
        }), this.showConsentHeader(), y && _t.setDisabledAttribute("#ot-selall-gnven-handler", null, !0)
        ...
        var e = St.PCAccordionStyle === W.Caret ? Cn.arrowEl.cloneNode(!0) : Cn.plusMinusEl.cloneNode(!0),
            ...
            o = t.cloneNode(!0);
        _t.removeChild(o.querySelector("#ot-selall-hostcntr")), _t.removeChild(t.querySelector("#ot-selall-vencntr")), _t.removeChild(t.querySelector("#ot-selall-licntr"));
        ...
        Vt("#onetrust-pc-sdk .ot-sel-all-hdr").show(), e.PAllowLI && !e.PShowLegIntBtn || Vt("#onetrust-pc-sdk .ot-li-hdr").hide()
    }, Pn.prototype.setBackBtnTxt = function() {
        lt.isV2Template ? (Vt(Ht.P_Vendor_List + " .back-btn-handler").attr(this.ARIA_LABEL_ATTRIBUTE, St.PCenterBackText), Vt(Ht.P_Vendor_List + " .back-btn-handler title").html(St.PCenterBackText)) : Vt(Ht.P_Vendor_List + " .back-btn-handler .pc-back-button-text").html(St.PCenterBackText)
        ...
        var s = n.cloneNode(!0);
        if (s.classList.add(Ht.P_c_Name), s.querySelector("div:nth-child(1)").innerHTML = St.pcCListName, s.querySelector("div:nth-child(2)").innerHTML = r, Vt(o).append(s), St.pcShowCookieHost) {
            var i = n.cloneNode(!0);
            i.classList.add(Ht.P_c_Host), i.querySelector("div:nth-child(1)").innerHTML = St.pcCListHost, i.querySelector("div:nth-child(2)").innerHTML = e.Host, Vt(o).append(i)
        }
        if (St.pcShowCookieDuration) {
            var a = n.cloneNode(!0);
            a.classList.add(Ht.P_c_Duration), a.querySelector("div:nth-child(1)").innerHTML = St.pcCListDuration, a.querySelector("div:nth-child(2)").innerHTML = e.IsSession ? St.LifespanTypeText : Gt.getDuration(e), Vt(o).append(a)
        }
        if (St.pcShowCookieType) {
            var l = t.Type === U.GenVendor ? !e.isThirdParty : t.isFirstParty,
                c = n.cloneNode(!0);
            c.classList.add(Ht.P_c_Type), c.querySelector("div:nth-child(1)").innerHTML = St.pcCListType, c.querySelector("div:nth-child(2)").innerHTML = l ? St.firstPartyTxt : St.thirdPartyTxt, Vt(o).append(c)
        }
        if (St.pcShowCookieCategory) {
            var d = void 0;
            if (d = t.Type === U.GenVendor ? e.category : t.isFirstParty ? e.groupName : t.groupName) {
                var u = n.cloneNode(!0);
                u.classList.add(Ht.P_c_Category), u.querySelector("div:nth-child(1)").innerHTML = St.pcCListCategory, u.querySelector("div:nth-child(2)").innerHTML = d, Vt(o).append(u)
            }
        }
        if (St.pcShowCookieDescription && e.description) {
            var p = n.cloneNode(!0);
            p.classList.add(Ht.P_c_Desc), p.querySelector("div:nth-child(1)").innerHTML = St.pcCListDescription, p.querySelector("div:nth-child(2)").innerHTML = e.description, Vt(o).append(p)
        }
        return o
    }, Pn);
    ...
    var An, Sn = (Tn.prototype.updateGtmMacros = function(e) {
        ...
        St.GoogleConsent.GCEnable && this.updateGCMTags(n), window.OnetrustActiveGroups = r, window.OptanonActiveGroups = r, At.otDataLayer.ignore || void 0 === this._window[At.otDataLayer.name] || this._window[At.otDataLayer.name].constructor !== Array ? !At.otDataLayer.ignore && At.otDataLayer.name && (this._window[At.otDataLayer.name] = [{
        ...
        !at.fireOnetrustGrp && s && !e && At.gtmUpdatedinStub || (at.fireOnetrustGrp = !1, !At.otDataLayer.ignore && this._window[At.otDataLayer.name] && this._window[At.otDataLayer.name].constructor === Array && this._window[At.otDataLayer.name].push({
        ...
        "function" == typeof window.gtag && (At.gcmDevIdSet || (window.gtag(le.set, "developer_id.dYWJhMj", !0), At.gcmDevIdSet = !0), a && (l || (t[pe.region] = At.gcmCountries), 0 !== Object.keys(t).length && window.gtag(le.consent, de.update, t)))
    ...
    var In, Ln = "Banner",
        ...
        On = (Nn.prototype.showConsentNotice = function() {
            switch (!St.NoBanner || St.ForceConsent ? Vt(".onetrust-pc-dark-filter").removeClass("ot-hide") : Vt(".onetrust-pc-dark-filter").addClass("ot-hide"), Vt("#onetrust-pc-sdk").removeClass("ot-hide"), At.pcName) {
                case Qe:
                    ...
                    var e = St.PreferenceCenterPosition,
                        ...
                        o = t ? "right" : "left",
                        n = t ? "left" : "right";
                    Vt("#onetrust-pc-sdk").el[0].classList.contains("ot-slide-out-" + ("right" === e ? n : o)) && Vt("#onetrust-pc-sdk").removeClass("ot-slide-out-" + ("right" === e ? n : o)), Vt("#onetrust-pc-sdk").addClass("ot-slide-in-" + ("right" === e ? n : o))
            }
            cn.setAllowAllButton(), sn.setPCFocus(sn.getPCElements()), St.NoBanner && St.ScrollCloseBanner || this.pcHasScroll()
        }, Nn.prototype.hideConsentNoticeV2 = function() {
            if (0 !== Vt(this.ONETRUST_PC_SDK).length) {
                if (lt.isV2Template && this.closePCText(), St.ForceConsent && !Gt.isCookiePolicyPage(St.AlertNoticeText) && !Ut.isAlertBoxClosedAndValid() && St.ShowAlertNotice ? Vt("" + this.ONETRUST_PC_DARK_FILTER).css("z-index: 2147483645;").show() : Vt("" + this.ONETRUST_PC_DARK_FILTER).fadeOut(St.PCLayout.Panel ? 500 : 400), St.PCLayout.Panel) {
                    var e = St.PreferenceCenterPosition,
                        t = St.useRTL,
                        o = t ? "right" : "left",
                        n = t ? "left" : "right";
                    Vt("" + this.ONETRUST_PC_SDK).removeClass("ot-slide-in-" + ("right" === e ? n : o)), Vt("" + this.ONETRUST_PC_SDK).addClass("ot-slide-out-" + ("right" === e ? n : o))
                }
                if (Vt("" + this.ONETRUST_PC_SDK).fadeOut(St.PCLayout.Panel ? 500 : 400), at.isPCVisible = !1, (!St.NoBanner || !St.ScrollCloseBanner) && this.bodyStyleChanged) {
                    var r = Vt("html").el[0],
                        s = Vt("body").el[0];
                    this.htmlStyleProp ? Tt(r, this.htmlStyleProp, !1) : r.removeAttribute("style"), this.bodyStyleProp ? Tt(s, this.bodyStyleProp, !1) : s.removeAttribute("style"), this.bodyStyleChanged = !1
                }
                if (at.pcLayer = T.Banner, at.pcSource || Ut.isAlertBoxClosedAndValid()) at.pcSource ? (at.pcSource.focus(), at.pcSource = null) : St.BInitialFocus ? Gt.resetFocusToBody() : this.setFocusOnPage();
                else {
            ...
            if (e.scrollHeight > e.clientHeight) {
                ...
                var t = Vt("body");
                t.length && (this.bodyStyleProp = t.el[0].style.cssText, this.htmlStyleProp = Vt("html").el[0].style.cssText, Tt(Vt("html").el[0], "overflow: hidden;", !0), Tt(Vt("body").el[0], "overflow: hidden;", !0))
            }
    ...
    var Dn, Hn = (Fn.prototype.init = function() {
        ...
        St.BannerRelativeFontSizesToggle && Vt(n).addClass("otRelFont"), St.useRTL && Vt(n).attr("dir", "rtl"), Vt(t).append(n);
        var r = St.NtfyConfig;
        this.initHtml("Sync", r.Sync, e, t.querySelector(this.El)), r.ShowCS ? Vt(e(".ot-pc-handler")).html(r.CSTxt) : (Vt(n).addClass("ot-hide-csbtn"), e(".ot-sync-btncntr").parentElement.removeChild(e(".ot-sync-btncntr")));
        ...
        var o = St.NtfyConfig;
        this.initHtml("Complete", o.Complete, e, t), o.ShowCS && ("LINK" === o.CSType && Vt(e(".ot-pc-handler")).addClass("ot-pc-link"), Vt(".ot-sync-btncntr").show("inline-block"), this.alignContent(), Vt(window).on("resize", function() {
        ...
        Vt(".ot-sync-btncntr").el[0].clientHeight > Vt(".ot-sync-titlecntr").el[0].clientHeight && (Vt(".ot-sync-titlecntr").addClass("ot-pos-abs"), Vt(".ot-sync-btncntr").addClass("ot-pos-rel"))
    ...
    var Rn, qn = (Mn.prototype.toggleVendorConsent = function(e, t) {
        void 0 === e && (e = []), void 0 === t && (t = null), e.length || (e = at.oneTrustIABConsent.vendors), e.forEach(function(e) {
            var t = e.split(":"),
                o = t[0],
                n = t[1],
        ...
        if (o) {
            ...
            null === t && (t = n.length === e.length), t || 0 === n.length ? o.parentElement.classList.remove(Ft.P_Line_Through) : o.parentElement.classList.add(Ft.P_Line_Through), _t.setCheckedAttribute("", o, t)
        }
    }, Mn.prototype.toggleVendorLi = function(e, t) {
        void 0 === e && (e = []), void 0 === t && (t = null), e.length || (e = at.oneTrustIABConsent.legIntVendors), e.forEach(function(e) {
            var t = e.split(":"),
                o = t[0],
                n = t[1],
        ...
        void 0 === e && (e = []), e.length || (e = at.oneTrustIABConsent.legIntVendors), e.forEach(function(e) {
            var t = e.split(":"),
                o = t[0],
                n = t[1],
    ...
    var Un, jn = (zn.prototype.setFilterList = function(t) {
        ...
        var n = t.CustomGroupId,
            r = n + "-filter",
            s = e.cloneNode(!0);
        Vt(Ht.P_Fltr_Modal + " " + Ht.P_Fltr_Options).append(s), Vt(s.querySelector("input")).attr("id", r), Vt(s.querySelector("label")).attr("for", r), lt.isV2Template ? Vt(s.querySelector(Ht.P_Label_Txt)).html(t.GroupName) : Vt(s.querySelector("label span")).html(t.GroupName), Vt(s.querySelector("input")).attr(o ? "data-optanongroupid" : "data-purposeid", n)
    }, zn);
        ...
        this.processedCSS = "", this.addCustomBannerCSS = function() {
            ...
            if ((t || n) && (h += "#onetrust-consent-sdk #onetrust-accept-btn-handler,\n                         #onetrust-banner-sdk #onetrust-reject-all-handler {\n                            " + (t ? "background-color: " + t + ";border-color: " + t + ";" : "") + "\n                " + (n ? "color: " + n + ";" : "") + "\n            }"), p && (h += "\n            #onetrust-consent-sdk #onetrust-banner-sdk *:focus,\n            #onetrust-consent-sdk #onetrust-banner-sdk:focus {\n               outline-color: " + p + ";\n               outline-width: 1px;\n            }"), (s || r) && (h += "\n            #onetrust-consent-sdk #onetrust-pc-btn-handler,\n            #onetrust-consent-sdk #onetrust-pc-btn-handler.cookie-setting-link {\n                " + (s ? "color: " + s + "; border-color: " + s + ";" : "") + "\n                background-color: \n                " + (r && !St.BannerSettingsButtonDisplayLink ? r : e) + ";\n            }"), At.bannerName === Je) {
                var g = void 0,
                    ...
                    f = void 0,
                    k = void 0;
                a && (g = "color: " + n + ";border-color: " + n + ";background-color: " + a + ";"), l && (C = "background-color: " + l + ";"), c && (y = "border-color: " + c + ";"), d && (f = "background-color: " + d + ";", k = "border-color: " + d + ";"), p && (h += "\n                #onetrust-consent-sdk #onetrust-banner-sdk .ot-tgl input:focus+.ot-switch .ot-switch-nob,\n                #onetrust-consent-sdk #onetrust-banner-sdk .ot-chkbox input:focus + label::before {\n                    outline-color: " + p + ";\n                    outline-width: 1px;\n                }"), h += "#onetrust-banner-sdk .ot-bnr-save-handler {" + g + "}#onetrust-banner-sdk .ot-cat-lst {" + C + "}#onetrust-banner-sdk .ot-cat-bdr {" + y + "}#onetrust-banner-sdk .ot-tgl input:checked+.ot-switch .ot-switch-nob:before,#onetrust-banner-sdk .ot-chkbox input:checked~label::before {" + f + "}#onetrust-banner-sdk .ot-chkbox label::before,#onetrust-banner-sdk .ot-tgl input:checked+.ot-switch .ot-switch-nob {" + k + "}#onetrust-banner-sdk #onetrust-pc-btn-handler.cookie-setting-link {background: inherit}"
            }
            return St.BCloseButtonType === ie.Link && (h += "#onetrust-banner-sdk.ot-close-btn-link .banner-close-button {color: " + St.BContinueColor + "}"), h
    ...
    var Yn, Xn = ($n.prototype.insertPcHtml = function() {
        ...
        if (Qo.preferenceCenterGroup) {
            ...
            if (St.ShowPreferenceCenterCloseButton)
                for (St.CloseText || (St.CloseText = "Close Preference Center"), i = 0; i < s.length; i++) St.PCCloseButtonType === ie.Link && St.PCTemplateUpgrade ? (Vt(s[i]).html(St.PCContinueText), Vt(o).addClass("ot-close-btn-link"), Vt(s[i]).el.removeAttribute("aria-label")) : Vt(s[i]).el.setAttribute("aria-label", St.CloseText);
            else
                for (var i = 0; i < s.length; i++) Vt(s[i].parentElement).el.removeChild(s[i]);
            ...
            if (a && St.optanonLogo) {
                ...
                Gt.checkMobileOfflineRequest(Gt.getBannerVersionUrl()) && (l = _t.getRelativeURL(l, !0, !0)), Vt(a).attr("style", 'background-image: url("' + l + '");\n                    background-position: ' + (St.useRTL ? "right" : "left") + ";"), St.PCLogoAria && Vt(a).attr("aria-label", St.PCLogoAria)
            }
            if (Gt.insertFooterLogo(r(".ot-pc-footer-logo a")), Vt(n(Ht.P_Title)).html(St.MainText), St.PCCloseButtonType === ie.Link && St.PCTemplateUpgrade && At.pcName === et && Vt(n(Ht.P_Title)).addClass("ot-pc-title-shrink"), Vt(n(go)).attr("aria-label", St.MainText), At.pcName === et && (Vt(n(Ht.P_Privacy_Txt)).html(St.AboutCookiesText), Vt(n(Ht.P_Privacy_Hdr)).html(St.AboutCookiesText)), Vt(n(Ht.P_Policy_Txt)).html(St.MainInfoText), St.AboutText && Vt(n(Ht.P_Policy_Txt)).html(Vt(n(Ht.P_Policy_Txt)).html() + '\n                <br/><a href="' + St.AboutLink + '" class="privacy-notice-link" rel="noopener" target="_blank"\n                        aria-label="' + St.PCCookiePolicyLinkScreenReader + '">' + St.AboutText + "</a>"), St.PCenterVendorListLinkText) {
            ...
            if (St.PCTemplateUpgrade && St.PCenterUserIdTitleText && St.IsConsentLoggingEnabled) {
                ...
                if (n(Ht.P_Policy_Txt).insertAdjacentHTML("beforeend", '<div class="ot-userid-title"><span>' + St.PCenterUserIdTitleText + ": </span> " + d + "</div>"), St.PCenterUserIdDescriptionText && n(Ht.P_Policy_Txt).insertAdjacentHTML("beforeend", '<div class="ot-userid-desc">' + St.PCenterUserIdDescriptionText + "</div>"), St.PCenterUserIdTimestampTitleText) {
            ...
            if (n(Ht.P_Manage_Cookies_Txt) && Vt(n(Ht.P_Manage_Cookies_Txt)).html(St.ManagePreferenceText), Yn.initializePreferenceCenterGroups(n, t), !St.IsIabEnabled) {
        ...
        k.setAttribute("class", "ot-text-resize"), k.setAttribute("title", "onetrust-text-resize"), Tt(k, "position: absolute; top: -50000px; width: 100em;"), k.setAttribute(this._ariaHidden, "true"), Vt(t.querySelector("#onetrust-pc-sdk")).append(k);
        var v = document.getElementById("onetrust-consent-sdk");
        Vt(v).append(t), At.ignoreInjectingHtmlCss || Vt(document.body).append(v), (St.showCookieList || at.showGeneralVendors) && fn.InitializeHostList()
        ...
        Vt(r).html(t), Vt(r).attr("id", o), At.pcName === et && (e.querySelector(Ht.P_Category_Header).innerHTML = t, e.querySelector("" + Ht.P_Desc_Container).setAttribute("id", n), e.querySelector(".category-menu-switch-handler").setAttribute("aria-controls", n))
    }, $n.prototype.setLegIntButton = function(e, t, o, n) {
        void 0 === o && (o = !1);
        var r = !0; - 1 < at.vendors.selectedLegInt.indexOf(t.IabGrpId + ":false") && (r = !1);
        ...
        var s = cn.safeFormattedGroupDescription(t),
            ...
            l = i || a;
        return -1 < bt.indexOf(t.Type) && o.PCGrpDescType === P.Legal ? s = t.DescriptionLegal : l.classList.add("ot-category-desc"), At.legIntSettings.PAllowLI && !At.legIntSettings.PShowLegIntBtn && (t.SubGroups.some(function(e) {
            return e.HasLegIntOptOut
        }) || t.HasLegIntOptOut ? l.parentElement.classList.add("ot-leg-border-color") : _t.removeChild(e.querySelector(Ht.P_Li_Hdr))), At.pcName !== et && l.setAttribute("id", n), Vt(l).html(s), t.Type === Ct && _t.removeChild(l), l
    }, $n.prototype.cloneOtHtmlEls = function(e) {
        var t = /otPcPanel|otPcCenter/;
        Cn.toggleEl = Vt(e(".ot-tgl")).el.cloneNode(!0), Cn.arrowEl = Vt(e("#onetrust-pc-sdk > " + Ht.P_Arrw_Cntr)).el.cloneNode(!0), Cn.subGrpEl = Vt(e(Ht.P_Sub_Grp_Cntr)).el.cloneNode(!0), Cn.vListEl = Vt(e(Ht.P_Ven_Lst_Cntr)).el.cloneNode(!0), Cn.cListEl = Vt(e(Ht.P_Host_Lst_cntr)).el.cloneNode(!0), Cn.chkboxEl = Vt(e(Ht.P_CBx_Cntr)).el.cloneNode(!0), Cn.accordionEl = Vt(e(".ot-acc-cntr")).el.cloneNode(!0), t.test(At.pcName) && (Cn.plusMinusEl = Vt(e(".ot-plus-minus")).el.cloneNode(!0)), _t.removeChild(e(".ot-tgl")), _t.removeChild(e("#onetrust-pc-sdk > " + Ht.P_Arrw_Cntr)), _t.removeChild(e(Ht.P_Sub_Grp_Cntr)), _t.removeChild(e(Ht.P_Ven_Lst_Cntr)), _t.removeChild(e(Ht.P_Host_Lst_cntr)), _t.removeChild(e(Ht.P_CBx_Cntr)), _t.removeChild(e(".ot-acc-cntr")), t.test(At.pcName) && _t.removeChild(e(".ot-plus-minus"))
    }, $n.prototype.insertSelectAllEls = function(e) {
        var t = e(Ht.P_Select_Cntr + " .ot-sel-all-chkbox"),
            o = Cn.chkboxEl.cloneNode(!0);
        o.id = Ht.P_Sel_All_Host_El, o.querySelector("input").id = "select-all-hosts-groups-handler", o.querySelector("label").setAttribute("for", "select-all-hosts-groups-handler"), Vt(t).append(o);
        var n = Cn.chkboxEl.cloneNode(!0);
        n.id = Ht.P_Sel_All_Vendor_Consent_El, n.querySelector("input").id = "select-all-vendor-groups-handler", n.querySelector("label").setAttribute("for", "select-all-vendor-groups-handler"), Vt(t).append(n);
        var r = Cn.chkboxEl.cloneNode(!0);
        r.id = Ht.P_Sel_All_Vendor_Leg_El, r.querySelector("input").id = "select-all-vendor-leg-handler", r.querySelector("label").setAttribute("for", "select-all-vendor-leg-handler"), Vt(t).append(r)
    }, $n.prototype.initializePreferenceCenterGroups = function(e, t) {
        var o = At.pcName;
        if (lt.isV2Template) {
            Yn.cloneOtHtmlEls(e);
            var n = Cn.chkboxEl.cloneNode(!0);
            n.querySelector("input").classList.add("category-filter-handler"), Vt(e(Ht.P_Fltr_Modal + " " + Ht.P_Fltr_Option)).append(n), Yn.insertSelectAllEls(e)
        }
        ...
        var s, i = e("#onetrust-pc-sdk " + Ht.P_Category_Item),
        ...
        At.legIntSettings.PAllowLI && At.grpContainLegalOptOut && "IAB2" === St.IabType && !At.legIntSettings.PShowLegIntBtn ? (u.querySelector("span:first-child").innerText = St.ConsentText, u.querySelector("span:last-child").innerText = St.LegitInterestText, lt.isV2Template && (u.querySelector("span:first-child").innerText = St.PCenterConsentText, u.querySelector("span:last-child").innerText = St.PCenterLegIntColumnHeader), St.PCenterEnableAccordion && u ? u.classList.add("ot-leg-border-color") : "otPcList" === o && i.insertAdjacentElement("afterbegin", u)) : (_t.removeChild(e("#onetrust-pc-sdk " + Ht.P_Li_Hdr)), _t.removeChild(i.querySelector(Ht.P_Li_Hdr)));
        for (var p = e(".ot-tab-desc"), h = 0; h < c.length; h++) {
            ...
            if (S = S[S.length - 1], d ? r.append(f) : A ? wt.insertAfter(f, S) : wt.insertAfter(f, r.el.querySelector(Ht.P_Li_Hdr) || r.el.querySelector("h3")), 0 < g.SubGroups.length && g.ShowSubgroup) {
        ...
        if ("otPcTab" === o)
            if (s && e("#onetrust-pc-sdk " + Ht.P_Category_Grp).insertAdjacentElement("afterbegin", s), p && 640 < window.innerWidth && Vt(p).append(t.querySelectorAll("#onetrust-pc-sdk " + Ht.P_Desc_Container)), St.IsIabEnabled) e(Ht.P_Desc_Container + " .category-vendors-list-handler").innerHTML = St.VendorListText + "&#x200E;";
            else {
        ...
        if (n.ShowVendorList) {
            var a = void 0,
                l = void 0;
            if (lt.isV2Template ? a = (l = Cn.vListEl.cloneNode(!0)).querySelector(".category-vendors-list-handler") : l = (a = e.querySelector(".category-vendors-list-handler")).parentElement, a.innerHTML = s.VendorListText + "&#x200E;", a.setAttribute("aria-label", St.PCOpensVendorDetailsAlert), a.setAttribute("data-parent-id", n.CustomGroupId), s.PCGrpDescType === P.UserFriendly && a.insertAdjacentHTML("afterend", "<a href='" + St.IabLegalTextUrl + "?lang=" + at.consentLanguage + "' rel=\"noopener\" target='_blank'>&nbsp;|&nbsp;" + s.PCVendorFullLegalText + '&nbsp;<span class="ot-scrn-rdr">' + St.NewWinTxt + "</span></a>"), lt.isV2Template) {
                var c = e;
                i === et ? c = e.querySelector("" + Ht.P_Desc_Container) : s.PCenterEnableAccordion && (c = e.querySelector(Ht.P_Acc_Txt)), c.insertAdjacentElement("beforeend", l)
            }
            ...
            if (i !== Qe && i !== Xe || s.PCenterEnableAccordion) {
                if (i === Ze || i === Qe || i === Xe && s.PCenterEnableAccordion) {
                    ...
                    d && o.querySelector("" + Ht.P_Content).removeChild(d), lt.isV2Template || Vt(u).el.removeChild(u.querySelector(Ht.P_Ven_Lst_Cntr))
                }
        ...
        if ((St.showCookieList || at.showGeneralVendors) && (n.ShowHostList || s || i)) {
            ...
            if (lt.isV2Template) {
                ...
                var c = e;
                r === et ? c = e.querySelector("" + Ht.P_Desc_Container) : St.PCenterEnableAccordion && (c = e.querySelector(Ht.P_Acc_Txt)), c.insertAdjacentElement("beforeend", l)
            ...
            p && o.querySelector("" + Ht.P_Content).removeChild(p), h.querySelector(Ht.P_Host_Lst_cntr) && Vt(h).el.removeChild(h.querySelector(Ht.P_Host_Lst_cntr))
        } else {
        ...
        A.SubGroups.forEach(function(e) {
            ...
            var o, n, r = lt.isV2Template ? S.cloneNode(!0) : S.el.cloneNode(!0),
            ...
            if (w) {
                ...
                var g = !1; - 1 < bt.indexOf(e.Type) && B && (g = !0, h = e.DescriptionLegal), I.PCenterEnableAccordion && g || (p = Vt(s.querySelector("p"))), A.ShowSubGroupDescription ? p.html(h) : p.html("")
            }
            if (A.ShowSubgroupToggle && -1 < E.indexOf(e.Type)) {
                var C = cn.isGroupActive(e);
                C && (s.querySelector("input").setAttribute("checked", ""), "always active" === c && -1 === bt.indexOf(e.Type) && (s.querySelector("input").disabled = !0, s.querySelector("input").setAttribute("disabled", !0)));
                var y = u.querySelector(".ot-label-status");
                if (St.PCShowConsentLabels ? y.innerHTML = C ? St.PCActiveText : St.PCInactiveText : _t.removeChild(y), At.legIntSettings.PAllowLI && e.Type === pt && e.HasLegIntOptOut)
                    if (At.legIntSettings.PShowLegIntBtn) Yn.setLegIntButton(s, e);
                        ...
                        v.setAttribute("id", a + "-leg-out"), f.querySelector("label").setAttribute("for", a + "-leg-out"), e.IsLegIntToggle = !0;
                        var b = cn.isGroupActive(e);
                        St.PCShowConsentLabels ? k.innerHTML = b ? St.PCActiveText : St.PCInactiveText : _t.removeChild(k), _t.setCheckedAttribute(null, v, b), e.IsLegIntToggle = !1
                    }
            ...
            if (t && (o.classList.add("ot-hide-tgl"), o.querySelector("input").setAttribute(L._ariaHidden, !0)), "always active" !== l || t || (o && o.parentElement.removeChild(o), s.querySelector(Ht.P_Tgl_Cntr).classList.add("ot-always-active-subgroup"), Yn.setAlwaysActive(s, !0)), "COOKIE" === e.Type && -1 !== e.Parent.indexOf("STACK") && Tt(r, "display: none;"), Vt(r.querySelector(Ht.P_Subgp_ul)).append(s), lt.isV2Template) {
                var m = T;
                "otPcTab" === _ ? m = T.querySelector("" + Ht.P_Desc_Container) : I.PCenterEnableAccordion && (m = T.querySelector(Ht.P_Acc_Txt)), m.insertAdjacentElement("beforeend", r)
            } else {
        ...
        var i = s.querySelector("input"),
            ...
            u = !0;
        if ("IAB2" !== At.iabType || o.Type !== pt && o.Type !== Ct || o.HasConsentOptOut || (u = !1), Vt(s.querySelector("label")).attr("for", n), Vt(s.querySelector(".ot-label-txt")).html(o.GroupName), At.legIntSettings.PAllowLI && o.Type === pt && o.HasLegIntOptOut)
            if (At.legIntSettings.PShowLegIntBtn) Yn.setLegIntButton(e, o, !0, t);
                ...
                St.PCShowConsentLabels ? g.innerHTML = h ? St.PCActiveText : St.PCInactiveText : _t.removeChild(g), o.IsLegIntToggle = !1, cn.setInputID(p.querySelector("input"), n + "-leg-out", d, h, r), Vt(p.querySelector("label")).attr("for", n + "-leg-out"), a.insertAdjacentElement("afterend", p)
            }
        var C = s.querySelector(".ot-label-status");
        St.PCShowConsentLabels ? C.innerHTML = l ? St.PCActiveText : St.PCInactiveText : _t.removeChild(C), !c && u || (s.classList.add("ot-hide-tgl"), s.querySelector("input").setAttribute(this._ariaHidden, !0)), u && (c ? Yn.setAlwaysActive(e) : (a.insertAdjacentElement("afterend", s), cn.setInputID(i, n, d, l, r))), St.PCenterEnableAccordion && (St.PCAccordionStyle === W.Caret ? a.insertAdjacentElement("afterend", Cn.arrowEl.cloneNode(!0)) : a.insertAdjacentElement("beforebegin", Cn.plusMinusEl.cloneNode(!0)))
        ...
        for (var d = 0; d < s.length; d++)
            if (i[d] && Vt(i[d]).attr("for", n), 2 <= s.length && 0 === d) Vt(s[d]).attr("id", n + "-toggle");
                ...
                var u = !0;
                if ("IAB2" !== At.iabType || o.Type !== pt && o.Type !== Ct || o.HasConsentOptOut || (u = !1), At.legIntSettings.PAllowLI && o.Type === pt && o.HasLegIntOptOut)
                    if (At.legIntSettings.PShowLegIntBtn) Yn.setLegIntButton(e, o, !0, t);
                    else {
                        ...
                        o.IsLegIntToggle = !1, cn.setInputID(g, n + "-leg-out", l, C, r), Vt(h.querySelector("label")).attr("for", n + "-leg-out"), _t.removeChild(h.querySelector(Ht.P_Arrw_Cntr))
                    }
        ...
        void 0 === t && (t = !1);
        var o = At.pcName;
        if (o === Ze || o === et || t) e.querySelector(Ht.P_Tgl_Cntr).insertAdjacentElement("afterbegin", Vt("<div class='ot-always-active'>" + St.AlwaysActiveText + "</div>", "ce").el);
        else {
            var n = e.querySelector(Ht.P_Category_Header);
            !lt.isV2Template && St.PCenterEnableAccordion && (n = e.querySelector(Ht.P_Arrw_Cntr)), Vt(n).el.insertAdjacentElement("afterend", Vt("<div class='ot-always-active'>" + St.AlwaysActiveText + "</div>", "ce").el)
        }
    ...
    var Qn, Zn = (er.prototype.showBanner = function() {
        ...
        if (lt.fp.CookieV2SSR) Vt(r).append(a), this._rejectBtn = e("#onetrust-reject-all-handler"), this._acceptBtn = e("#onetrust-accept-btn-handler");
        else {
            var l = [{
                type: "purpose",
            ...
            if (Qo.bannerGroup) {
                St.BannerRelativeFontSizesToggle && Vt(a).addClass("otRelFont"), (St.BInitialFocus || St.BInitialFocusLinkAndButton) && a.setAttribute("tabindex", "0"), St.useRTL && Vt(a).attr("dir", "rtl"), "IAB2" === At.iabType && St.BannerDPDDescription.length && Vt(a).addClass("ot-iab-2");
                var c = St.BannerPosition;
                if (c && ("bottom-left" === c ? Vt(a).addClass("ot-bottom-left") : "bottom-right" === c ? Vt(a).addClass("ot-bottom-right") : Vt(a).addClass(c)), Vt(r).append(a), St.BannerTitle ? (Vt(e("#onetrust-policy-title")).html(St.BannerTitle), Vt(e('[role="alertdialog"]')).attr("aria-label", St.BannerTitle)) : (_t.removeChild(e("#onetrust-policy-title")), Vt(e("#onetrust-banner-sdk")).addClass("ot-wo-title"), Vt(e('[role="alertdialog"]')).attr("aria-label", St.AriaPrivacy)), !St.IsIabEnabled && at.showGeneralVendors && St.BannerNonIABVendorListText) {
                    var d = document.createElement("div");
                    d.setAttribute("id", "ot-gv-link-ctnr"), Vt(d).html('<button class="ot-link-btn ot-gv-list-handler">' + St.BannerNonIABVendorListText + "</button>"), Vt(e("#onetrust-policy")).el.appendChild(d)
                }
                Vt(e("#onetrust-policy-text")).html(St.AlertNoticeText), St.BShowPolicyLink && St.BShowImprintLink && Vt(e("#onetrust-policy-text a")).length ? (Vt(e("#onetrust-policy-text a:first-child")).attr("aria-label", St.BCookiePolicyLinkScreenReader), Vt(e("#onetrust-policy-text a:last-child")).attr("aria-label", St.BImprintLinkScreenReader)) : St.BShowPolicyLink && Vt(e("#onetrust-policy-text a")).length ? Vt(e("#onetrust-policy-text a")).attr("aria-label", St.BCookiePolicyLinkScreenReader) : St.BShowImprintLink && Vt(e("#onetrust-policy-text a")).length && Vt(e("#onetrust-policy-text a")).attr("aria-label", St.BImprintLinkScreenReader), "IAB2" === St.IabType && St.BannerDPDDescription.length && s !== Je ? (Vt(e(".ot-dpd-container .ot-dpd-title")).html(St.BannerDPDTitle), Vt(e(".ot-dpd-container .ot-dpd-desc")).html(St.BannerDPDDescription.join(",&nbsp;"))) : _t.removeChild(e(".ot-dpd-container"));
                ...
                if (s === Ue && ("IAB2" === At.iabType && (u.removeClass("ot-sdk-eight"), St.showBannerAcceptButton && f.insertAdjacentElement("afterbegin", this._acceptBtn), St.showBannerCookieSettings && f.insertAdjacentElement("beforeend", e("#onetrust-pc-btn-handler"))), C && !g && "IAB2" === At.iabType ? u.addClass("ot-sdk-nine") : C && g ? u.addClass("ot-sdk-eleven") : !C && g ? u.addClass("ot-sdk-twelve") : C || g || "IAB2" !== At.iabType || (u.addClass("ot-sdk-ten"), Vt(e("#onetrust-button-group-parent")).addClass("ot-sdk-two"), Vt(e("#onetrust-button-group-parent")).removeClass("ot-sdk-three"))), C && s === ze && "IAB2" === At.iabType && !k) {
                    var b = e(".banner-close-btn-container");
                    b.parentElement.removeChild(b), Vt(a).el.insertAdjacentElement("beforeEnd", b), Vt(e("#onetrust-banner-sdk .ot-sdk-container")).addClass("ot-top-cntr")
                }
                var m = Vt(e("#banner-options")).el;
                n ? (s === Ke ? this.setFloatingRoundedIconBannerCmpOptions(e, l) : (this.setCmpBannerOptions(e, l), s === Je && u.el.insertAdjacentElement("beforeend", m)), Vt(window).on("resize", function() {
        ...
        At.bannerName === Je && lt.moduleInitializer.IsSuppressPC && (at.dataGroupState = St.Groups.filter(function(e) {
            return e.Order
        })), At.bannerName === Je && (this._fourBtns = St.BannerShowRejectAllButton && St.showBannerAcceptButton && St.showBannerCookieSettings && St.BShowSaveBtn, this._saveBtn = e(".ot-bnr-save-handler"), this._settingsBtn = e("#onetrust-pc-btn-handler"), this._btnsCntr = e(".banner-actions-container"), St.BShowSaveBtn ? Vt(this._saveBtn).html(St.BSaveBtnTxt) : (_t.removeChild(this._saveBtn), this._saveBtn = null), Gt.insertFooterLogo(t(".ot-bnr-footer-logo a")), this._descriptCntr = e(".ot-cat-lst"), this.setBannerBtn(), window.addEventListener("resize", function() {
            o.setBannerBtn()
        }), this._fourBtns && Vt(e("#onetrust-banner-sdk")).addClass("has-reject-all-button"), this.insertGrps(e));
        var P = document.createElement("div");
        Vt(P).append(r), At.ignoreInjectingHtmlCss || (Vt("#onetrust-consent-sdk").append(P.firstChild), n && this.setBannerOptionContent()), this.setBnrBtnGrpAlignment()
        ...
        t === Ue ? "bottom" === St.BannerPosition ? (e.css("bottom: -99px;"), e.animate({
            bottom: "0px"
        }, 1e3), at.bnrAnimationInProg = !0, setTimeout(function() {
            e.css("bottom: 0px;"), at.bnrAnimationInProg = !1
        }, 1e3)) : (e.css("top: -99px; bottom: auto;"), At.pagePushedDown && !po.checkIsBrowserIE11OrBelow() ? po.BannerPushDownHandler() : (e.animate({
            top: "0"
        }, 1e3), at.bnrAnimationInProg = !0, setTimeout(function() {
            e.css("top: 0px; bottom: auto;"), at.bnrAnimationInProg = !1
        }, 1e3))) : t !== je && t !== We || (e.css("bottom: -300px;"), e.animate({
            bottom: "1em"
        }, 2e3), at.bnrAnimationInProg = !0, setTimeout(function() {
            e.css("bottom: 1rem;"), at.bnrAnimationInProg = !1
        }, 2e3))
    }, er.prototype.setBannerBtn = function() {
        window.innerWidth <= 600 ? (_t.insertElement(this._btnsCntr, this._settingsBtn, "afterbegin"), _t.insertElement(this._btnsCntr, this._saveBtn, "afterbegin"), _t.insertElement(this._btnsCntr, this._acceptBtn, "afterbegin"), _t.insertElement(this._btnsCntr, this._rejectBtn, "afterbegin")) : this._fourBtns ? (this._descriptCntr.insertAdjacentElement("beforeend", this._settingsBtn), this._acceptBtn.insertAdjacentElement("beforebegin", this._rejectBtn), this._btnsCntr.insertAdjacentElement("beforebegin", this._saveBtn)) : (_t.insertElement(this._btnsCntr, this._settingsBtn, "beforebegin"), _t.insertElement(this._btnsCntr, this._saveBtn, this._settingsBtn ? "afterbegin" : "beforebegin"), _t.insertElement(this._btnsCntr, this._rejectBtn, "beforeend"), _t.insertElement(this._btnsCntr, this._acceptBtn, "beforeend"))
        ...
        e.forEach(function(e) {
            ...
            if (o || n) {
                ...
                n ? (r.setAttribute("id", "option-details-" + a++), r.innerHTML = n) : r.parentElement.removeChild(r), Vt(s("#banner-options")).el.appendChild(t)
            }
        })
        ...
        Vt(r("#banner-options")).html(""), e.forEach(function(e) {
            var t = s.cloneNode(!0),
                o = St[e.titleKey],
                n = St[e.descriptionKey];
            (o || n) && (t.setAttribute("id", e.identifier), t.querySelector(".banner-option-header :first-child").innerHTML = o, Vt(r("#banner-options")).el.appendChild(t))
        }), e.forEach(function(e) {
        ...
        _t.removeChild(e(".ot-cat-item")), St.BCategoryStyle === oe.Checkbox ? _t.removeChild(p.querySelector(".ot-tgl")) : (_t.removeChild(p.querySelector(".ot-chkbox")), Vt(p).addClass("ot-cat-bdr"));
        ...
        St.Groups.forEach(function(e) {
            ...
            l && (St.BCategoryStyle === oe.Toggle ? (_t.removeChild(o), t.insertAdjacentElement("beforeend", Vt("<div class='ot-always-active'>" + St.AlwaysActiveText + "</div>", "ce").el)) : Vt(d).attr("disabled", !0)), d.classList.add("category-switch-handler"), cn.setInputID(d, s, r, c, i);
    ...
    var tr, or = (nr.prototype.initCookieSettingHandlers = function() {
        ...
        Vt(".ot-floating-button__open").on("click", tr.floatingCookieSettingOpenBtnClicked), Vt(".ot-floating-button__close").on("click", tr.floatingCookieSettingCloseBtnClicked)
    }, nr.prototype.floatingCookieSettingOpenBtnClicked = function(e) {
        Vt(tr.fltgBtnSltr).addClass("ot-pc-open"), St.cookiePersistentLogo.includes("ot_guard_logo.svg") && Vt(tr.fltgBtnFSltr).attr("aria-hidden", "true"), Vt(tr.fltgBtnBSltr).attr("aria-hidden", ""), Vt(tr.fltgBtnFrontBtn).el[0].setAttribute("aria-label", ""), Vt(tr.fltgBtnFrontBtn).el[0].setAttribute("aria-hidden", !0), Vt(tr.fltgBtnBackBtn).el[0].setAttribute("aria-label", St.AriaClosePreferences), Vt(tr.fltgBtnBackBtn).el[0].setAttribute("aria-hidden", !1), fo.triggerGoogleAnalyticsEvent(Po, Vo), tr.showCookieSettingsHandler(e)
    }, nr.prototype.floatingCookieSettingCloseBtnClicked = function(e) {
        Vt(tr.fltgBtnFrontBtn).el[0].setAttribute("aria-label", St.AriaOpenPreferences), Vt(tr.fltgBtnFrontBtn).el[0].setAttribute("aria-hidden", !1), Vt(tr.fltgBtnBackBtn).el[0].setAttribute("aria-label", ""), Vt(tr.fltgBtnBackBtn).el[0].setAttribute("aria-hidden", !0), e && (fo.triggerGoogleAnalyticsEvent(Po, Go), tr.hideCookieSettingsHandler(e))
    }, nr.prototype.initialiseLegIntBtnHandlers = function() {
        Vt(document).on("click", ".ot-obj-leg-btn-handler", tr.onLegIntButtonClick), Vt(document).on("click", ".ot-remove-objection-handler", tr.onLegIntButtonClick)
    }, nr.prototype.initialiseAddtlVenHandler = function() {
        Vt("#onetrust-pc-sdk #ot-addtl-venlst").on("click", tr.selectVendorsGroupHandler), Vt("#onetrust-pc-sdk #ot-selall-adtlven-handler").on("click", tr.selAllAdtlVenHandler)
    }, nr.prototype.initializeGenVenHandlers = function() {
        Vt("#onetrust-pc-sdk #ot-gn-venlst .ot-gnven-chkbox-handler").on("click", tr.genVendorToggled), Vt("#onetrust-pc-sdk #ot-gn-venlst .ot-gv-venbox").on("click", tr.genVendorDetails), Vt("#onetrust-pc-sdk #ot-selall-gnven-handler").on("click", tr.selectAllGenVenHandler)
    }, nr.prototype.initialiseConsentNoticeHandlers = function() {
        var e = this,
            t = 37,
            o = 39;
        if (At.pcName === et && tr.categoryMenuSwitchHandler(), Vt("#onetrust-pc-sdk .onetrust-close-btn-handler").on("click", tr.bannerCloseButtonHandler), Vt("#onetrust-pc-sdk #accept-recommended-btn-handler").on("click", rr.allowAllEventHandler.bind(this, !0)), Vt("#onetrust-pc-sdk .ot-pc-refuse-all-handler").on("click", rr.rejectAllEventHandler.bind(this, !0)), Vt("#onetrust-pc-sdk #close-pc-btn-handler").on("click", tr.hideCookieSettingsHandler), Vt(document).on("keydown", function(e) {
                ...
                if (27 === e.keyCode && t && o) {
                    ...
                    "block" === n.style.display || "0px" < n.style.width ? (tr.closeFilter(), Vt("#onetrust-pc-sdk #filter-btn-handler").focus()) : St.NoBanner && !St.ShowPreferenceCenterCloseButton || tr.hideCookieSettingsHandler(), tr.confirmPC()
                }(o && 32 === e.keyCode || "Space" === e.code || 13 === e.keyCode || "Enter" === e.code) && Gt.findUserType(e)
            }), Vt("#onetrust-pc-sdk #vendor-close-pc-btn-handler").on("click", tr.hideCookieSettingsHandler), Vt("#onetrust-pc-sdk .category-switch-handler").on("click", tr.toggleV2Category), Vt("#onetrust-pc-sdk .cookie-subgroup-handler").on("click", tr.toggleSubCategory), Vt("#onetrust-pc-sdk .category-menu-switch-handler").on("keydown", function(e) {
                At.pcName === et && (e.keyCode !== t && e.keyCode !== o || (St.PCTemplateUpgrade ? tr.changeSelectedTabV2(e) : tr.changeSelectedTab(e)))
            }), Vt("#onetrust-pc-sdk").on("click", Ht.P_Category_Item + " > input:first-child," + Ht.P_Category_Item + " > button:first-child", tr.onCategoryItemToggle.bind(this)), (St.showCookieList || at.showGeneralVendors) && (Vt("#onetrust-pc-sdk .category-host-list-handler").on("click", function(e) {
                at.showGeneralVendors && St.showCookieList ? at.cookieListType = z.HostAndGenVen : at.showGeneralVendors ? at.cookieListType = z.GenVen : at.cookieListType = z.Host, tr.pcLinkSource = e.target, tr.loadCookieList(e.target)
            }), Gt.isOptOutEnabled() ? (Vt("#onetrust-pc-sdk #select-all-hosts-groups-handler").on("click", tr.selectAllHostsGroupsHandler), Vt("#onetrust-pc-sdk " + Ht.P_Host_Cntr).on("click", tr.selectHostsGroupHandler)) : Vt("#onetrust-pc-sdk " + Ht.P_Host_Cntr).on("click", tr.toggleAccordionStatus)), St.IsIabEnabled && (Vt("#onetrust-pc-sdk .category-vendors-list-handler").on("click", function(e) {
                tr.pcLinkSource = e.target, tr.showVendorsList(e.target)
            }), Vt("#onetrust-pc-sdk " + Ht.P_Vendor_Container).on("click", tr.selectVendorsGroupHandler), St.UseGoogleVendors || tr.bindSelAllHandlers(), tr.initialiseLegIntBtnHandlers()), St.IsIabEnabled || St.showCookieList || at.showGeneralVendors) {
            Vt(document).on("click", ".back-btn-handler", tr.backBtnHandler), Vt("#onetrust-pc-sdk #vendor-search-handler").on("keyup", function(e) {
                var t = e.target.value.trim();
                tr.isCookieList ? bn.searchHostList(t) : (bn.loadVendorList(t, []), St.UseGoogleVendors && bn.searchVendors(bn.googleSearchSelectors, at.addtlVendorsList, Q.GoogleVendor, t), at.showGeneralVendors && bn.searchVendors(bn.genVendorSearchSelectors, St.GeneralVendors, Q.GeneralVendor, t)), bn.playSearchStatus(tr.isCookieList)
                ...
                9 !== e.keyCode && "tab" !== e.code || e.shiftKey || (e.preventDefault(), Vt("#onetrust-pc-sdk #clear-filters-handler").el[0].focus())
            }) : Vt("#onetrust-pc-sdk #filter-apply-handler").on("keydown", function(e) {
                9 !== e.keyCode && "tab" !== e.code || e.shiftKey || (e.preventDefault(), Vt("#onetrust-pc-sdk .category-filter-handler").el[0].focus())
            });
            var n = Vt("#onetrust-pc-sdk .category-filter-handler").el;
            Vt(n[0]).on("keydown", function(e) {
                9 !== e.keyCode && "tab" !== e.code || !e.shiftKey || (e.preventDefault(), Vt("#onetrust-pc-sdk #filter-apply-handler").el[0].focus())
            })
        }
        St.NoBanner && (St.OnClickCloseBanner && document.body.addEventListener("click", rr.bodyClickEvent), St.ScrollCloseBanner && window.addEventListener("scroll", rr.scrollCloseBanner)), Vt("#onetrust-pc-sdk .ot-gv-list-handler").on("click", function(t) {
        ...
        if (e && e.target && e.target.className) {
            ...
            if (-1 < t.indexOf("save-preference-btn-handler")) at.bannerCloseSource = f.ConfirmChoiceButton, fo.triggerGoogleAnalyticsEvent(Po, wo);
            else if (-1 < t.indexOf("banner-close-button")) {
                at.bannerCloseSource = f.BannerCloseButton;
                var o = So; - 1 < t.indexOf("ot-close-link") && (o = To, at.bannerCloseSource = f.ContinueWithoutAcceptingButton), fo.triggerGoogleAnalyticsEvent(Po, o)
            } else -1 < t.indexOf("ot-bnr-save-handler") && (at.bannerCloseSource = f.BannerSaveSettings, fo.triggerGoogleAnalyticsEvent(Po, Io))
        }
        ...
        ro.toggleGroupHosts(t, o), at.genVenOptOutEnabled && ro.toggleGroupGenVendors(t, o), t.IsLegIntToggle = e, cn.toggleGrpStatus(t, o), t.SubGroups && t.SubGroups.length && (At.bannerName === Je && lt.moduleInitializer.IsSuppressPC && t.SubGroups.length ? t.SubGroups.forEach(function(e) {
            e.IsLegIntToggle = t.IsLegIntToggle, cn.toggleGrpStatus(e, o), e.IsLegIntToggle = !1, ro.toggleGroupHosts(e, o), at.genVenOptOutEnabled && ro.toggleGroupGenVendors(e, o)
        }) : cn.toogleAllSubGrpElements(t, o)), this.allowAllVisible(cn.setAllowAllButton()), t.IsLegIntToggle = !1
        ...
        return l(this, void 0, void 0, function() {
            return h(this, function(e) {
                switch (e.label) {
                    ...
                    case 1:
                        return e.sent(), tr.showVendorsList(null, !0), at.isPCVisible ? [3, 3] : [4, tr.showCookieSettingsHandler(t)];
                    case 2:
                        e.sent(), e.label = 3;
                    case 3:
                        return [2]
        ...
        return tr.setVendorContent(), fn.updateFilterSelection(!1), at.pcLayer = T.VendorList, e && sn.setPCFocus(sn.getPCElements()), this.setSearchInputFocus(), !1
        ...
        if (t) {
            ...
            at.filterByCategories.push(t), o.SubGroups.length && o.SubGroups.forEach(function(e) {
        ...
        return bn.loadHostList("", at.filterByCategories), Vt("#onetrust-pc-sdk #filter-count").text(at.filterByCategories.length.toString()), fn.updateFilterSelection(!0), at.pcLayer = T.CookieList, sn.setPCFocus(sn.getPCElements()), this.setSearchInputFocus(), !1
        ...
        for (var i = 0; i < n.length; i++) {
            _t.setCheckedAttribute(null, n[i], r), St.PCShowConsentLabels && (n[i].parentElement.querySelector(".ot-label-status").innerHTML = r ? St.PCActiveText : St.PCInactiveText);
        ...
        }) : "googleven" === t ? at.addtlVendors.vendorSelected = {} : (at.genVendorsConsent = {}, at.alwaysActiveGenVendors.forEach(function(e) {
        ...
        r.some(function(e, t) {
            ...
            return e.vendorId === n
        }).vendorName + ": IABV2_" + n), t.selectedLegIntVendors[i] = n + ":" + !s, At.legIntSettings.PShowLegIntBtn || bn.vendorLegIntToggleEvent()) : e === V.AddtlConsent ? (o.vendorSelected[n] ? delete o.vendorSelected[n] : o.vendorSelected[n] = !0, bn.venAdtlSelAllTglEvent()) : (fo.triggerGoogleAnalyticsEvent(Po, s ? jo : Uo, t.list.find(function(e) {
            return e.vendorId === n
        }).vendorName + ": IABV2_" + n), t.selectedVendors[i] = n + ":" + !s, bn.vendorsListEvent())
        ...
        return l(this, void 0, void 0, function() {
            ...
            return h(this, function(e) {
                switch (e.label) {
                    case 0:
                        return (t = at.discVendors)[n].isFetched ? [3, 2] : (t[n].isFetched = !0, [4, Yo.getStorageDisclosure(t[n].disclosureUrl)]);
                    case 1:
        ...
        t ? tr.onVendorToggle(t, V.LI) : o ? tr.onVendorToggle(o, V.Consent) : n && tr.onVendorToggle(n, V.AddtlConsent), r && tr.onVendorDisclosure(r), (t || o || n) && (_t.setCheckedAttribute(null, e.target, e.target.checked), St.PCShowConsentLabels && (e.target.parentElement.querySelector(".ot-label-status").innerHTML = e.target.checked ? St.PCActiveText : St.PCInactiveText))
        ...
        switch (At.pcName) {
            ...
            case et:
                ...
                break;
            case Ze:
                896 < window.innerWidth || 896 < window.screen.height ? Tt(t, "width: 400px;", !0) : Tt(t, "height: 100%; width: 100%;"), t.querySelector(".ot-checkbox input").focus();
                break;
            default:
                return
        }
        lt.isV2Template && !e && (Vt("#onetrust-pc-sdk").addClass("ot-shw-fltr"), Vt("#onetrust-pc-sdk .ot-fltr-scrlcnt").el[0].scrollTop = 0)
    }, nr.prototype.clearFiltersHandler = function() {
        tr.setAriaLabelforButtonInFilter(St.PCenterFilterClearedAria);
        for (var e = Vt("#onetrust-pc-sdk " + Ht.P_Fltr_Modal + " input").el, t = 0; t < e.length; t++) _t.setCheckedAttribute(null, e[t], !1);
        tr.isCookieList ? at.filterByCategories = [] : at.filterByIABCategories = []
    }, nr.prototype.cancelFilterHandler = function() {
        tr.isCookieList ? fn.cancelHostFilter() : bn.cancelVendorFilter(), tr.closeFilter(), Vt("#onetrust-pc-sdk #filter-btn-handler").focus()
    }, nr.prototype.applyFilterHandler = function() {
        var e;
        tr.setAriaLabelforButtonInFilter(St.PCenterFilterAppliedAria), tr.isCookieList ? (e = fn.updateHostFilterList(), bn.loadHostList("", e)) : (e = bn.updateVendorFilterList(), bn.loadVendorList("", e)), Vt("#onetrust-pc-sdk #filter-count").text(String(e.length)), tr.closeFilter(), Vt("#onetrust-pc-sdk #filter-btn-handler").focus()
    }, nr.prototype.setAriaLabelforButtonInFilter = function(e) {
        var t = document.querySelector("#onetrust-pc-sdk span[aria-live]");
        t || ((t = document.createElement("span")).classList.add("ot-scrn-rdr"), t.setAttribute("aria-atomic", "true"), document.getElementById("onetrust-pc-sdk").appendChild(t)), t.setAttribute("aria-atomic", "true"), t.setAttribute("aria-relevant", "additions"), t.setAttribute("aria-live", "assertive"), t.setAttribute("aria-label", e), tr.timeCallback && clearTimeout(tr.timeCallback), tr.timeCallback = setTimeout(function() {
        ...
        Vt("#onetrust-pc-sdk " + Ht.P_Content).el[0].classList.contains("ot-hide") ? Tt(Vt("#onetrust-pc-sdk").el[0], 'height: "";', !0) : setTimeout(function() {
            ...
            768 <= window.innerWidth && 600 <= window.innerHeight && (e = .8 * window.innerHeight), !Vt("#onetrust-pc-sdk " + Ht.P_Content).el[0].scrollHeight || Vt("#onetrust-pc-sdk " + Ht.P_Content).el[0].scrollHeight >= e ? Tt(Vt("#onetrust-pc-sdk").el[0], "height: " + e + "px;", !0) : Tt(Vt("#onetrust-pc-sdk").el[0], "height: auto;", !0)
        })
    }, nr.prototype.changeSelectedTab = function(e) {
        var t, o = Vt("#onetrust-pc-sdk .category-menu-switch-handler"),
            n = 0,
            r = Vt(o.el[0]);
        o.each(function(e, t) {
            Vt(e).el.classList.contains(Ht.P_Active_Menu) && (n = t, Vt(e).el.classList.remove(Ht.P_Active_Menu), r = Vt(e))
        }), e.keyCode === L.RightArrow ? t = n + 1 >= o.el.length ? Vt(o.el[0]) : Vt(o.el[n + 1]) : e.keyCode === L.LeftArrow && (t = Vt(n - 1 < 0 ? o.el[o.el.length - 1] : o.el[n - 1])), this.tabMenuToggle(t, r)
        ...
        for (var t = this, e = Vt("#onetrust-pc-sdk .category-menu-switch-handler").el, o = 0; o < e.length; o++) e[o].addEventListener("click", this.groupTabClick), e[o].addEventListener("keydown", function(e) {
        ...
        if (void 0 === e && (e = !0), !In.checkIfPcSdkContainerExist()) {
            ...
            At.pcName === Ze ? 896 < window.innerWidth || 896 < window.screen.height ? Tt(t, "width: 0;", !0) : Tt(t, "height: 0;") : Tt(t, "display: none;"), o && Vt(o).attr("style", "display: none;"), lt.isV2Template && Vt("#onetrust-pc-sdk").removeClass("ot-shw-fltr"), e && sn.setFirstAndLast(sn.getPCElements())
        }
        ...
        if (tr.setMainContentHeight(), At.pcName === et && e) {
            ...
            else e.querySelector(".category-menu-switch-handler + " + Ht.P_Desc_Container) && 640 < window.innerWidth && Vt(e.querySelector(".ot-tab-desc")).append(t)
        }
        ...
        var e = this.pc,
            ...
            r = n[n.length - 1],
            s = St.PCLayout;
        if (e.classList.remove("ot-ftr-stacked"), n[0] && r && 1 < Math.abs(n[0].offsetTop - r.offsetTop) && e.classList.add("ot-ftr-stacked"), !St.PCTemplateUpgrade && !s.Center) {
        ...
        } else Tt(e.querySelector("" + Ht.P_Content), "height: " + (e.clientHeight - t.clientHeight - o.clientHeight - 3) + "px;", !0)
    }, nr.prototype.allowAllVisible = function(e) {
        e !== this.allowVisible && St.PCLayout.Tab && St.PCTemplateUpgrade && (this.pc && this.setMainContentHeight(), this.allowVisible = e)
    }, nr.prototype.restorePc = function() {
        at.pcLayer === T.CookieList ? (tr.hideCategoryContainer(!0), bn.loadHostList("", at.filterByCategories), Vt("#onetrust-pc-sdk #filter-count").text(at.filterByCategories.length.toString())) : at.pcLayer === T.VendorList && (tr.hideCategoryContainer(!1), tr.setVendorContent()), at.isPCVisible = !1, tr.toggleInfoDisplay(), at.pcLayer !== T.VendorList && at.pcLayer !== T.CookieList || (fn.updateFilterSelection(at.pcLayer === T.CookieList), tr.setBackButtonFocus(), sn.setPCFocus(sn.getPCElements()))
        ...
        return l(this, void 0, void 0, function() {
            ...
            return h(this, function(e) {
                switch (e.label) {
                    case 0:
                        return Qo.csBtnGroup && (Vt(tr.fltgBtnSltr).addClass("ot-pc-open"), tr.otGuardLogoPromise.then(function() {
                            St.cookiePersistentLogo.includes("ot_guard_logo.svg") && Vt(tr.fltgBtnFSltr).attr("aria-hidden", "true")
                        }), Vt(tr.fltgBtnBSltr).attr("aria-hidden", "")), [4, tr.fetchAndSetupPC()];
                    case 1:
                        return e.sent(), At.pcName === $e && this.setPcListContainerHeight(), void 0 !== at.pcLayer && at.pcLayer !== T.Banner || (at.pcLayer = T.PrefCenterHome), t = Vt("#onetrust-pc-sdk").el[0], Vt(".onetrust-pc-dark-filter").el[0].removeAttribute("style"), t.removeAttribute("style"), at.isPCVisible || (In.showConsentNotice(), at.isPCVisible = !0, St.PCTemplateUpgrade && (this.pc = t, o = t.querySelector("#accept-recommended-btn-handler"), this.allowVisible = o && 0 < o.clientHeight, this.setCenterLayoutFooterHeight(), tr.getResizeElement().addEventListener("resize", tr.setCenterLayoutFooterHeight), window.addEventListener("resize", tr.setCenterLayoutFooterHeight))), window.dispatchEvent(new CustomEvent("OneTrustPCLoaded", {
                            OneTrustPCLoaded: "yes"
                        })), tr.captureInitialConsent(), [2]
                }
            })
        })
    }, nr.prototype.close = function(e) {
        St.BCloseButtonType === ie.Link ? at.bannerCloseSource = f.ContinueWithoutAcceptingButton : at.bannerCloseSource = f.BannerCloseButton, rr.bannerCloseButtonHandler(e), tr.getResizeElement().removeEventListener("resize", tr.setCenterLayoutFooterHeight), window.removeEventListener("resize", tr.setCenterLayoutFooterHeight)
        ...
        }), Vt("#onetrust-banner-sdk .category-switch-handler").on("click", tr.toggleBannerCategory), Vt("#onetrust-banner-sdk").on("keydown", function(e) {
            9 !== e.keyCode && "tab" !== e.code || sn.handleBannerFocus(e, e.shiftKey), 32 !== e.keyCode && "Space" !== e.code && 13 !== e.keyCode && "Enter" !== e.code || Gt.findUserType(e)
        })
        ...
        var t, o;
        void 0 === e && (e = !1);
        for (var n = St.CookieSettingButtonText, r = Vt(".ot-sdk-show-settings").el, s = Vt(".optanon-toggle-display").el, i = 0; i < r.length; i++) Vt(r[i]).text(n), Vt(s[i]).text(n);
        e ? (null !== (t = document.querySelector(".ot-sdk-show-settings")) && void 0 !== t && t.addEventListener("click", this.cookiesSettingsBoundListener), null !== (o = document.querySelector(".optanon-toggle-display")) && void 0 !== o && o.addEventListener("click", this.cookiesSettingsBoundListener)) : tr.initCookieSettingHandlers()
        ...
        at.initialGroupsConsent = JSON.parse(JSON.stringify(at.groupsConsent)), at.initialHostConsent = JSON.parse(JSON.stringify(at.hostsConsent)), at.showGeneralVendors && (at.initialGenVendorsConsent = JSON.parse(JSON.stringify(at.genVendorsConsent))), St.IsIabEnabled && (at.initialOneTrustIABConsent = JSON.parse(JSON.stringify(at.oneTrustIABConsent)), at.initialVendors = JSON.parse(JSON.stringify(at.vendors)), at.initialVendors.vendorTemplate = at.vendors.vendorTemplate), St.UseGoogleVendors && (at.initialAddtlVendorsList = JSON.parse(JSON.stringify(at.addtlVendorsList)), at.initialAddtlVendors = JSON.parse(JSON.stringify(at.addtlVendors)))
    }, nr);
        ...
        this.fltgBtnSltr = "#ot-sdk-btn-floating", this.fltgBtnFrontBtn = ".ot-floating-button__front button", this.fltgBtnBackBtn = ".ot-floating-button__back button", this.fltgBtnFSltr = ".ot-floating-button__front svg", this.fltgBtnBSltr = ".ot-floating-button__back svg", this.pc = null, this.allowVisible = !1, this.pcLinkSource = null, this.isCookieList = !1, this.otGuardLogoResolve = null, this.otGuardLogoPromise = new Promise(function(e) {
            ...
            return l(t, void 0, void 0, function() {
                ...
                return h(this, function(e) {
                    switch (e.label) {
                        case 0:
                            return s && s.stopPropagation(), s && s.target && (t = s.target.className, o = "onetrust-pc-btn-handler" === s.target.id, n = "ot-sdk-show-settings" === t, (o || n) && (r = o ? _o : Bo, fo.triggerGoogleAnalyticsEvent(Po, r)), at.pcSource = s.target), [4, tr.toggleInfoDisplay()];
                        case 1:
                            return e.sent(), [2, !1]
                    }
                })
            ...
            void 0 === o && (o = Vt(this).is(":checked")), St.ChoicesBanner && _t.setCheckedAttribute("#ot-bnr-grp-id-" + t.CustomGroupId, null, o), n ? document.querySelector("#ot-group-id-" + n) && (_t.setCheckedAttribute("#ot-group-id-" + n, null, o), r = document.querySelector("#ot-group-id-" + n)) : (r = this, _t.setCheckedAttribute(null, this, o), r.parentElement.querySelector(".ot-switch-nob").setAttribute("aria-checked", o)), St.PCShowConsentLabels && (r.parentElement.parentElement.querySelector(".ot-label-status").innerHTML = o ? St.PCActiveText : St.PCInactiveText);
            ...
            void 0 === o && (o = Vt(this).is(":checked")), n ? (_t.setCheckedAttribute("#ot-sub-group-id-" + n, null, o), r = document.querySelector("#ot-sub-group-id-" + n)) : (r = this, _t.setCheckedAttribute(null, this, o)), St.PCShowConsentLabels && (r.parentElement.parentElement.querySelector(".ot-label-status").innerHTML = o ? St.PCActiveText : St.PCInactiveText);
    ...
    var rr, sr = (ir.prototype.updateDataSubjectTimestamp = function() {
        ...
        St.Groups.forEach(function(e) {
            ...
            C(e.SubGroups, [e]).forEach(function(e) {
                var o = !!t || !!n && Mt.isAlwaysActiveGroup(e); - 1 < ft.indexOf(e.Type) && at.groupsConsent.push(e.CustomGroupId + ":" + (o && e.HasConsentOptOut ? "1" : "0")), e.Hosts.length && Gt.isOptOutEnabled() && e.Hosts.forEach(function(e) {
        ...
        }), St.IsIabEnabled && (t ? this.iab.allowAllhandler() : this.iab.rejectAllHandler()), In.hideConsentNoticeV2(), Qt.writeGrpParam(Te.OPTANON_CONSENT), Qt.writeHstParam(Te.OPTANON_CONSENT), at.genVenOptOutEnabled && Qt.writeGenVenCookieParam(Te.OPTANON_CONSENT), fn.substitutePlainTextScriptTags(), An.updateGtmMacros(), this.executeOptanonWrapper()
        ...
        St.ScrollCloseBanner && window.removeEventListener("scroll", this.scrollCloseBanner), St.OnClickCloseBanner && document.body.removeEventListener("click", this.bodyClickEvent)
    }, ir.prototype.onClickCloseBanner = function(e) {
        Ut.isAlertBoxClosedAndValid() || (fo.triggerGoogleAnalyticsEvent(Po, Ao), this.closeBanner(St.OnClickAcceptAllCookies), e.stopPropagation()), rr.rmScrollAndClickBodyEvents()
        ...
        this.bannerActionsHandler(!0, !1), this.consentTransactions(e, !0, t), St.IsIabEnabled && (this.iab.updateIabVariableReference(), this.iab.updateVendorsDOMToggleStatus(!0), this.updateVendorLegBtns(!0))
        ...
        for (var o = t ? F[5] : F[2], n = this.groupsClass.getAllGroupElements(), r = 0; r < n.length; r++) {
            ...
            "always active" !== Mt.getGrpStatus(s).toLowerCase() && (cn.toggleGrpElements(n[r], s, !1), this.groupsClass.toogleSubGroupElement(n[r], !1, !1, !0), this.groupsClass.toogleSubGroupElement(n[r], !1, !0, !0))
        }
        this.bannerActionsHandler(!1, !0), o !== at.consentInteractionType && this.consentTransactions(e, !1, t), St.IsIabEnabled && (this.iab.updateIabVariableReference(), this.iab.updateVendorsDOMToggleStatus(!1), this.updateVendorLegBtns(!1))
    }, ir.prototype.executeCustomScript = function() {
        St.CustomJs && new Function(St.CustomJs)()
    }, ir.prototype.updateConsentData = function(e) {
        ao.setLandingPathParam(Ae), St.IsIabEnabled && !e && this.iab.saveVendorStatus(), Qt.writeGrpParam(Te.OPTANON_CONSENT), Qt.writeHstParam(Te.OPTANON_CONSENT), at.showGeneralVendors && St.GenVenOptOut && Qt.writeGenVenCookieParam(Te.OPTANON_CONSENT), fn.substitutePlainTextScriptTags(), An.updateGtmMacros()
    }, ir.prototype.close = function(e, t) {
        if (void 0 === t && (t = !1), In.hideConsentNoticeV2(), this.updateConsentData(e), St.IsConsentLoggingEnabled) {
            var o = t ? xn : Bn,
                n = t ? _n : Ln;
            at.bannerCloseSource === f.ContinueWithoutAcceptingButton && (o = Gn), at.bannerCloseSource === f.BannerSaveSettings && (o = Vn), Kt.createConsentTxn(!1, n + " - " + o, t)
        ...
        try {
            if (this.executeCustomScript(), "function" == typeof window.OptanonWrapper && "undefined" !== window.OptanonWrapper) {
                ...
                for (var e = 0, t = at.srcExecGrpsTemp; e < t.length; e++) {
                    var o = t[e]; - 1 === at.srcExecGrps.indexOf(o) && at.srcExecGrps.push(o)
                }
                at.srcExecGrpsTemp = [];
                for (var n = 0, r = at.htmlExecGrpsTemp; n < r.length; n++) o = r[n], -1 === at.htmlExecGrps.indexOf(o) && at.htmlExecGrps.push(o);
                at.htmlExecGrpsTemp = []
            }
        } catch (e) {
        ...
        if (At.legIntSettings.PAllowLI && At.legIntSettings.PShowLegIntBtn)
            for (var t = Vt(Ht.P_Vendor_Container + " .ot-leg-btn-container").el, o = 0; o < t.length; o++) this.groupsClass.updateLegIntBtnElement(t[o], e)
    }, ir.prototype.showFltgCkStgButton = function() {
        var e = Vt("#ot-sdk-btn-floating");
        e.removeClass("ot-hide"), e.removeClass("ot-pc-open"), St.cookiePersistentLogo.includes("ot_guard_logo.svg") && Vt(".ot-floating-button__front svg").attr("aria-hidden", ""), Vt(".ot-floating-button__back svg").attr("aria-hidden", "true")
    }, ir.prototype.consentTransactions = function(e, t, o) {
        void 0 === o && (o = !1), Kt && !e && St.IsConsentLoggingEnabled ? Kt.createConsentTxn(!1, (o ? _n : Ln) + " - " + (t ? En : wn), o) : Ut.dispatchConsentEvent()
    }, ir.prototype.hideVendorsList = function() {
        In.checkIfPcSdkContainerExist() || (St.PCTemplateUpgrade ? Vt("#onetrust-pc-sdk " + Ht.P_Content).removeClass("ot-hide") : Vt("#onetrust-pc-sdk .ot-main-content").show(), Vt("#onetrust-pc-sdk #close-pc-btn-handler.main").show(), Vt("#onetrust-pc-sdk " + Ht.P_Vendor_List).addClass("ot-hide"))
    }, ir.prototype.resetConsent = function() {
        var e = this;
        at.groupsConsent = JSON.parse(JSON.stringify(at.initialGroupsConsent)), at.hostsConsent = JSON.parse(JSON.stringify(at.initialHostConsent)), at.showGeneralVendors && (at.genVendorsConsent = JSON.parse(JSON.stringify(at.initialGenVendorsConsent))), St.IsIabEnabled && (at.oneTrustIABConsent = JSON.parse(JSON.stringify(at.initialOneTrustIABConsent)), at.vendors = JSON.parse(JSON.stringify(at.initialVendors)), at.vendors.vendorTemplate = at.initialVendors.vendorTemplate), St.UseGoogleVendors && (at.addtlVendors = JSON.parse(JSON.stringify(at.initialAddtlVendors)), at.addtlVendorsList = JSON.parse(JSON.stringify(at.initialAddtlVendorsList))), this.updateConsentData(!1), setTimeout(function() {
            e.resetConsentUI()
        }, 400)
        ...
        cn.getAllGroupElements().forEach(function(e) {
            ...
            if (At.pcName === et && St.PCTemplateUpgrade && (e = document.querySelector("#ot-desc-id-" + e.getAttribute("data-optanongroupid"))), o.Type === ct || o.Type === Ct) {
        ...
        if (St.UseGoogleVendors && s && s.length)
            for (var i = 0, a = s; i < a.length; i++) {
                var l;
                n = (l = a[i]).getAttribute("addtl-vid"), at.addtlVendorsList[n] && (r = Boolean(at.addtlVendors.vendorSelected[n]), _t.setCheckedAttribute("", l, r))
            }
    }, ir.prototype.isGroupActive = function(e, t) {
        var o;
        if (e.IabGrpId) {
            var n = void 0;
            n = e.Type === ht ? at.initialVendors.selectedSpecialFeatures : e.IsLegIntToggle ? at.initialVendors.selectedLegInt : at.initialVendors.selectedPurpose, o = -1 !== wt.inArray(e.IabGrpId + ":true", n)
        ...
        if (At.legIntSettings.PAllowLI && e.Type === pt && e.HasLegIntOptOut && At.legIntSettings.PShowLegIntBtn) {
            var o = !0; - 1 < at.vendors.selectedLegInt.indexOf(e.IabGrpId + ":false") && (o = !1), cn.updateLegIntBtnElement(t, o)
        }
    ...
    function ir() {
        var o = this;
        this.iab = bn, this.groupsClass = cn, this.closeOptanonAlertBox = function() {
            if (Gt.hideBanner(), St.NtfyConfig.ShowNtfy && Dn.hideSyncNtfy(), At.isOptInMode || !At.isOptInMode && !Ut.isAlertBoxClosedAndValid()) fo.setAlertBoxClosed(!0), St.PCTemplateUpgrade && St.PCenterUserIdTitleText && St.IsConsentLoggingEnabled && o.updateDataSubjectTimestamp();
            ...
            if (void 0 === e && (e = !1), rr.closeOptanonAlertBox(), lt.moduleInitializer.MobileSDK) window.OneTrust.Close();
            else {
            ...
            fo.triggerGoogleAnalyticsEvent(Po, t), lt.moduleInitializer.MobileSDK ? window.OneTrust.RejectAll() : (o.rejectAllEvent(!1, e), o.hideVendorsList())
        }, this.rejectAllEvent = function(e, t) {
            void 0 === e && (e = !1), void 0 === t && (t = !1), o.closeOptanonAlertBox(), Ut.isIABCrossConsentEnabled() ? At.thirdPartyiFrameLoaded ? o.rejectAll(e, t) : At.thirdPartyiFramePromise.then(function() {
                o.rejectAll(e, t)
            }) : o.rejectAll(e, t)
        }
    }
    var ar, lr = (cr.prototype.initBanner = function() {
        this.canImpliedConsentLandingPage(), lt.moduleInitializer.CookieSPAEnabled ? Vt(window).on("otloadbanner", this.windowLoadBanner.bind(this)) : Vt(window).one("otloadbanner", this.windowLoadBanner.bind(this))
        ...
        e && o && Vt(o).removeClass("ot-hide"), Vt("#onetrust-consent-sdk").append(o), St.cookiePersistentLogo && (St.cookiePersistentLogo.includes("ot_guard_logo.svg") ? this.applyPersistentSvgOnDOM() : Vt(".ot-floating-button__front, .ot-floating-button__back").addClass("custom-persistent-icon"))
    ...
    function cr() {
        this.iab = bn, this.core = fn, this.FLOATING_COOKIE_BTN = "#ot-sdk-btn-floating", this.FLOATING_COOKIE_FRONT_BTN = "#ot-sdk-btn-floating .ot-floating-button__front .ot-floating-button__open"
    }
    var dr, ur = (pr.prototype.initialiseLandingPath = function() {
        ...
        if (ao.isLandingPage()) ao.setLandingPathParam(location.href);
            ...
            if (e && !Ut.awaitingReconsent()) return ao.setLandingPathParam(location.href), void Lt.writeCookieParam(Te.OPTANON_CONSENT, ke, !0);
            e || Lt.writeCookieParam(Te.OPTANON_CONSENT, ke, !1), ao.setLandingPathParam(Ae), At.isSoftOptInMode && !lt.moduleInitializer.MobileSDK && fo.setAlertBoxClosed(!0), St.NextPageCloseBanner && St.ShowAlertNotice && rr.nextPageCloseBanner()
        }
    }, pr);
    ...
    var hr, gr = (Cr.prototype.IsAlertBoxClosedAndValid = function() {
        ...
        void 0 === e && (e = !1), fe.insertViewPortTag(), Qo.ensureHtmlGroupDataInitialised(), An.updateGtmMacros(!1), dr.initialiseLandingPath(), e || Kn.initialiseCssReferences()
        ...
        void 0 === t && (t = !1), e && e.trim() && (e = e.replace(/ /g, ""), Lt.writeCookieParam(Te.OPTANON_CONSENT, ve, e, !0), at.dsParams.isAnonymous = t)
        ...
        t.forEach(function(e) {
            var t = e.split(":"),
                ...
                r = s[n];
            r ? r.TransactionType === Ie ? (i.push(t[0] + ":1"), o.Parent ? tr.toggleSubCategory(null, o.CustomGroupId, !0, o.CustomGroupId) : tr.toggleV2Category(null, o, !0, o.CustomGroupId)) : (i.push(t[0] + ":0"), o.Parent ? tr.toggleSubCategory(null, o.CustomGroupId, !1, o.CustomGroupId) : tr.toggleV2Category(null, o, !1, o.CustomGroupId)) : i.push(t[0] + ":" + t[1])
        ...
        e && (St.Groups.forEach(function(e) {
            C(e.SubGroups, [e]).forEach(function(e) {
                var t = e.CustomGroupId,
                    o = _t.indexOf(i, t);
                if (-1 !== o) {
                    var n = Mt.getGrpStatus(e).toLowerCase(); - 1 < d.indexOf(n) && (r = !0, s[o] = t + ("inactive landingpage" === n ? ":1" : ":0"))
                }
            })
        }), r && Qt.writeGrpParam(Te.OPTANON_CONSENT, s)), t && (St.Groups.forEach(function(e) {
            C(e.SubGroups, [e]).forEach(function(n) {
                n.Hosts.forEach(function(e) {
                    var t = _t.indexOf(c, e.HostId);
                    if (-1 !== t) {
                        var o = Mt.getGrpStatus(n).toLowerCase(); - 1 < d.indexOf(o) && (a = !0, l[t] = e.HostId + ("inactive landingpage" === o ? ":1" : ":0"))
                    }
                })
            })
        ...
        if (t !== at.lang) {
            ...
            Yo.getLangJson(t).then(function(e) {
                e ? (At.init(e), Qo.fetchAssets().then(function() {
                    var e = document.getElementById("onetrust-style");
                    e && (e.textContent = ""), Kn.initialiseCssReferences(), o.IsSuppressPC && !at.isPCVisible || (_t.removeChild(Vt("#onetrust-pc-sdk").el), at.vendorDomInit = !1, at.genVendorDomInit = !1, Yn.insertPcHtml(), tr.initialiseConsentNoticeHandlers(), St.IsIabEnabled && bn.InitializeVendorList(), at.isPCVisible && tr.restorePc());
                    var t = !0;
                    Ut.isAlertBoxClosedAndValid() || o.IsSuppressBanner && (!o.IsSuppressBanner || at.skipAddingHTML) || St.NoBanner || (_t.removeChild(Vt("#onetrust-banner-sdk").el), tr.initializeAlartHtmlAndHandler(), t = !1), hr.initCookiePolicyAndSettings(), _t.removeChild(Vt("#ot-sdk-btn-floating").el), ar.insertCSBtn(t), hr.processedHtml = null
                })) : console.error("Language:" + t + " doesn't exist for the geo rule")
            })
        }
    }, Cr.prototype.initCookiePolicyAndSettings = function(e) {
        var t, o;
        void 0 === e && (e = !1), e && (null !== (t = document.querySelector(".ot-sdk-show-settings")) && void 0 !== t && t.removeEventListener("click", tr.cookiesSettingsBoundListener), null !== (o = document.querySelector(".optanon-toggle-display")) && void 0 !== o && o.removeEventListener("click", tr.cookiesSettingsBoundListener)), pn.insertCookiePolicyHtml(), tr.insertCookieSettingText(e)
        ...
        e.forEach(function(e) {
            var t = "";
            t = e.Status && "always active" === e.Status.toLowerCase() ? "Always Active" : cn.isGroupActive(e) ? "Active" : "Inactive", n.push({
        ...
        At.conditionalLogicEnabled ? console.groupCollapsed("Geolocation, Template & Condition") : console.groupCollapsed("Geolocation and Template"), at.userLocation.country && console.info("The Geolocation is " + i.country.toUpperCase()), console.info("The Geolocation rule is " + s.Name), console.info("The GeolocationRuleGroup is " + a), At.canUseConditionalLogic ? (console.info("The Condition name is " + At.Condition.Name), console.info("The TemplateName is " + At.Condition.TemplateName)) : console.info("The TemplateName is " + s.TemplateName), console.groupEnd();
        var l = e.filter(function(e) {
            return cn.isGroupActive(e) && "COOKIE" === e.Type
        });
        console.groupCollapsed("The cookies expected to be active if blocking has been implemented are"), l.forEach(function(e) {
    ...
    function Cr() {
        this.processedHtml = "", this.useGeoLocationService = !0, this.IsAlertBoxClosed = this.IsAlertBoxClosedAndValid, this.InitializeBanner = function() {
            ...
            return document.getElementById("onetrust-banner-sdk") || (Yn.insertPcHtml(), Qn.insertAlertHtml()), hr.processedHtml || (hr.processedHtml = document.querySelector("#onetrust-consent-sdk").outerHTML), hr.processedHtml
            ...
            hr.setDataSubjectIdV2(e.identifier, e.isAnonymous), hr.synchroniseCookieWithPayload(e.purposes), rr.executeOptanonWrapper()
        }, this.InsertScript = function(e, t, o, n, r, s) {
            var i, a = null != n && void 0 !== n,
                l = a && void 0 !== n.ignoreGroupCheck && !0 === n.ignoreGroupCheck;
            if (cn.canInsertForGroup(r, l) && !_t.contains(at.srcExecGrps, r)) {
                at.srcExecGrpsTemp.push(r), a && void 0 !== n.deleteSelectorContent && !0 === n.deleteSelectorContent && _t.empty(t);
                ...
                switch (null != o && void 0 !== o && (i = !1, c.onload = c.onreadystatechange = function() {
                    ...
                    default:
                        ...
                        d && (d.appendChild(c), a && void 0 !== n.makeSelectorVisible && !0 === n.makeSelectorVisible && _t.show(t))
                }
            ...
            if (cn.canInsertForGroup(r, i) && !_t.contains(at.htmlExecGrps, r)) {
                if (at.htmlExecGrpsTemp.push(r), s && void 0 !== n.deleteSelectorContent && !0 === n.deleteSelectorContent && _t.empty(t), _t.appendTo(t, e), s && void 0 !== n.makeSelectorVisible && !0 === n.makeSelectorVisible && _t.show(t), s && void 0 !== n.makeElementsVisible)
    ...
    var yr, fr, kr, vr, br = (o(fr = Pr, kr = yr = gr), fr.prototype = null === kr ? Object.create(kr) : (mr.prototype = kr.prototype, new mr), Pr.prototype.Close = function(e) {
    ...
    var Ar, Sr = (Tr.prototype.syncConsentProfile = function(e, t, o) {
        void 0 === o && (o = !1), e ? (at.dsParams.id = e.trim(), hr.setDataSubjectIdV2(e)) : e = at.dsParams.id, o && (at.dsParams.isAnonymous = o), t = t || at.dsParams.token, e && t && Yo.getConsentProfile(e, t).then(function(e) {
        ...
        o.syncGroups && o.syncGroups[at.syncGrpId] && o.syncGroups[at.syncGrpId].tcStringV2 ? Lt.getCookie(Te.EU_PUB_CONSENT) !== o.syncGroups[at.syncGrpId].tcStringV2 && (e.syncRequired = !0, Lt.setCookie(Te.EU_PUB_CONSENT, o.syncGroups[at.syncGrpId].tcStringV2, t, !1, new Date(e.alertBoxCookieVal))) : e.profileFound = !1
        ...
        for (var e = function(e) {
                var t = e.getAttribute("data-optanongroupid"),
                    ...
                    r = _t.findIndex(at.groupsConsent, function(e) {
                        return e.split(":")[0] === t
                    }); - 1 < r && at.groupsConsent[r].split(":")[1] === q.InActive && (n = !1), cn.toggleGrpElements(e, o, n), cn.toogleSubGroupElement(e, n, !1, !0), cn.toogleSubGroupElement(e, n, !0, !0)
            }, t = 0, o = cn.getAllGroupElements(); t < o.length; t++) e(o[t])
    }, Tr.prototype.updateVendorsDom = function() {
        St.IsIabEnabled && (bn.updateIabVariableReference(), Rn.toggleVendorConsent(), At.legIntSettings.PAllowLI && (At.legIntSettings.PShowLegIntBtn ? Rn.updateVendorLegBtns() : Rn.toggleVendorLi()))
    ...
    var Ir, Lr = (_r.prototype.removeCookies = function() {
        Lt.removePreview(), Lt.removeOptanon(), Lt.removeAlertBox(), Lt.removeIab2(), Lt.removeAddtlStr(), Lt.removeVariant(), at.isPreview && Ir.setPreviewCookie(), at.urlParams.get("otreset") && at.urlParams.set("otreset", "false");
        ...
        "string" == typeof e.data && e.data === Ir.CLEAR_COOKIES && (Ir.removeCookies(), e.source && e.source.postMessage && e.source.postMessage(Ir.CLEARED_COOKIES, e.origin))
    }, _r);
    ...
    fe.initPolyfill(), Lt = new Bt, Gt = new Nt, At = new mt, bo = new Wo, Ir = new Lr,
        function() {
            ...
            if (t) {
                ...
                }(), At.canUseConditionalLogic = !At.allConditionsFailed)), at.userLocation = t.userLocation, at.crossOrigin = t.crossOrigin, At.bannerDataParentURL = t.bannerBaseDataURL, At.mobileOnlineURL = C(At.mobileOnlineURL, t.mobileOnlineURL);
                var o = At.getRegionRule();
                At.multiVariantTestingEnabled = lt.moduleInitializer.MultiVariantTestingEnabled && 0 < o.Variants.length && Gt.isDateCurrent(o.TestEndTime), At.otDataLayer = t.otDataLayer, at.grpsSynced = t.grpsSynced || [], at.isIabSynced = t.isIabSynced, at.isGacSynced = t.isGacSynced, at.syncRequired = t.isIabSynced || t.isGacSynced || t.grpsSynced && 0 < t.grpsSynced.length, at.consentPreferences = t.preferences, at.syncGrpId = t.syncGrpId, at.consentApi = t.consentApi, at.tenantId = t.tenantId, at.geoFromUrl = t.geoFromUrl, at.nonce = t.nonce, at.setAttributePolyfillIsActive = t.setAttributePolyfillIsActive, at.storageBaseURL = t.storageBaseURL, bo.populateLangSwitcherPlhdr(), window.otStubData = {
        ...
        function() {
            l(this, void 0, void 0, function() {
                ...
                return h(this, function(e) {
                    switch (e.label) {
                        case 0:
                            return Mt = new jt, cn = new dn, on = new nn, bn = new mn, fn = new kn, rr = new sr, tr = new or, Yn = new Xn, Qn = new Zn, ar = new lr, pn = new hn, Kn = new Wn, to = new oo, Qo = new en, An = new Sn, dr = new ur, fo = new ko, Cn = new yn, Ar = new Sr, Rn = new qn, Yo = new Xo, sn = new an, In = new On, lt.moduleInitializer.MobileSDK ? vr = new br : hr = new gr, Yt = new Xt, t = At.getRegionRule(), o = At.canUseConditionalLogic ? At.Condition.UseGoogleVendors : t.UseGoogleVendors, "IAB2" !== At.getRegionRuleType() ? [3, 2] : [4, Promise.all([Yo.getLangJson(), Yo.fetchGvlObj(), o ? Yo.fetchGoogleVendors() : Promise.resolve(null), Yo.loadCMP()])];
                        case 1:
                            return i = e.sent(), n = i[0], r = i[1], s = i[2], at.gvlObj = r, at.addtlVendorsList = s ? s.vendors : null, [3, 4];
                        case 2:
                                        ...
                                        switch (e.label) {
                                            case 0:
                                                return window.OneTrust = window.Optanon = Object.assign({}, window.OneTrust, function(e) {
                                                        ...
                                                        e.IsConsentLoggingEnabled && (n.getDataSubjectId = t.getDataSubjectId, n.setConsentProfile = t.setConsentProfile, n.setDataSubjectId = t.setDataSubjectIdV2, at.isV2Stub && (n.syncConsentProfile = Ar.syncConsentProfile));
                                                        o && (n.mobileOnlineURL = t.mobileOnlineURL, n.otCookieData = at.otCookieData);
                                                        e.IsIabEnabled && (n.updateConsentFromCookies = fo.updateConsentFromCookie, n.getPingRequest = Yt.getPingRequestForTcf, n.getVendorConsentsRequestV2 = Yt.getVendorConsentsRequestV2, n.showVendorsList = t.showVendorsList);
                                                        return n
                                                    }(r.DomainData)), Ut.initializeBannerVariables(r), Qt = new Zt, ro = new so, Kt = new Wt, po = new Co, ao = new co, Un = new jn, Dn = new Hn,
                                                    function() {
                                                        ...
                                                        if (o && o.consentedDate && (o.groups || o.tcString || o.addtlString)) {
                                                            ...
                                                            e.forEach(function(e) {
                                                                ...
                                                                preferences: n,
                                                                syncGroups: null
                                                            }, at.syncRequired = !0, Qt.updateGroupsInCookie(Te.OPTANON_CONSENT, e), Lt.setCookie(Te.ALERT_BOX_CLOSED, o.consentedDate, 365), o.tcString && (at.isIabSynced = !0, Lt.setCookie(Te.EU_PUB_CONSENT, o.tcString, 365)), o.addtlString && (at.isGacSynced = !0, Lt.setCookie(Te.ADDITIONAL_CONSENT_STRING, "" + o.addtlString, 365))
                                                        }
                                                    }(), at.isPreview && (Ut.syncOtPreviewCookie(), Ir.bindStopPreviewEvent()), t = Ar.syncPreferences(at.consentPreferences, !0), (at.syncRequired || t.syncRequired) && Ut.syncAlertBoxCookie(t.alertBoxCookieVal), Ut.syncCookieExpiry(), o = window.OneTrust.dataSubjectParams || {}, (at.dsParams = o).id && hr.setDataSubjectIdV2(o.id, o.isAnonymous), At.multiVariantTestingEnabled && At.selectedVariant && Lt.setCookie(Te.SELECTED_VARIANT, At.selectedVariant.Id, St.ReconsentFrequencyDays), [4, Yt.initializeIABModule()];
                                            case 1:
                                                return e.sent(), window.OneTrust.Init(!0), [4, Qo.fetchAssets()];
                                            case 2:
                                                return (e.sent(), ar.initBanner(), fo.assetResolve(!0), Kn.initialiseCssReferences(), n = Ut.isIABCrossConsentEnabled(), (at.syncedValidGrp || at.isIabSynced || at.isGacSynced) && !n && St.NtfyConfig.ShowNtfy && Ut.isAlertBoxClosedAndValid()) ? (at.ntfyRequired = !0, [4, Dn.getContent()]) : [3, 4];
                                            case 3:
                                                e.sent(), e.label = 4;
                                            case 4:
